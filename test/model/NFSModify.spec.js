...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Onepanel.NFSModify();
  });
  ...
  describe('NFSModify', function() {
    it('should create an instance of NFSModify', function() {
      // uncomment below and update the code to test NFSModify
      //var instane = new Onepanel.NFSModify();
      //expect(instance).to.be.a(Onepanel.NFSModify);
    });
