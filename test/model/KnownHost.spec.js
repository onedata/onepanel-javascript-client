...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Onepanel.KnownHost();
  });
  ...
  describe('KnownHost', function() {
    it('should create an instance of KnownHost', function() {
      // uncomment below and update the code to test KnownHost
      //var instane = new Onepanel.KnownHost();
      //expect(instance).to.be.a(Onepanel.KnownHost);
    });
