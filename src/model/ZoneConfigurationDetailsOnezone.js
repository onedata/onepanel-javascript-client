...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.Onepanel.ZoneConfigurationDetailsOnezone = factory(root.Onepanel.ApiClient);
  }
  ...
  /**
   * The ZoneConfigurationDetailsOnezone model module.
   * @module model/ZoneConfigurationDetailsOnezone
   * @version 18.02.1
   */

  /**
   * Constructs a new <code>ZoneConfigurationDetailsOnezone</code>.
   ...
   *
   * @return {module:model/ZoneConfigurationDetailsOnezone} The value of 'discriminator' field or undefined.
   */
  ...
  /**
   * Constructs a <code>ZoneConfigurationDetailsOnezone</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/ZoneConfigurationDetailsOnezone} obj Optional instance to populate.
   * @return {module:model/ZoneConfigurationDetailsOnezone} The populated <code>ZoneConfigurationDetailsOnezone</code> instance.
   */
