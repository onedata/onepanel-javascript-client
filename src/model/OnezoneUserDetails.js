...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.Onepanel.OnezoneUserDetails = factory(root.Onepanel.ApiClient);
  }
  ...
  /**
   * The OnezoneUserDetails model module.
   * @module model/OnezoneUserDetails
   * @version 18.02.0-rc2
   */

  /**
   * Constructs a new <code>OnezoneUserDetails</code>.
   * The user configuration details.
   * @alias module:model/OnezoneUserDetails
   * @class
   * @param userId {String} The user ID.
   * @param userRole {module:model/OnezoneUserDetails.UserRoleEnum} The user role, one of `admin` or `regular`.
   */
   ...
   *
   * @return {module:model/OnezoneUserDetails} The value of 'discriminator' field or undefined.
   */
  ...
  /**
   * Constructs a <code>OnezoneUserDetails</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/OnezoneUserDetails} obj Optional instance to populate.
   * @return {module:model/OnezoneUserDetails} The populated <code>OnezoneUserDetails</code> instance.
   */
   ...
   * @member {module:model/OnezoneUserDetails.UserRoleEnum} userRole
   */
