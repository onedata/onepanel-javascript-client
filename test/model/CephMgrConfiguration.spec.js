...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Onepanel.CephMgrConfiguration();
  });
  ...
  describe('CephMgrConfiguration', function() {
    it('should create an instance of CephMgrConfiguration', function() {
      // uncomment below and update the code to test CephMgrConfiguration
      //var instane = new Onepanel.CephMgrConfiguration();
      //expect(instance).to.be.a(Onepanel.CephMgrConfiguration);
    });
