...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Onepanel.CephPoolModifyRequest();
  });
  ...
  describe('CephPoolModifyRequest', function() {
    it('should create an instance of CephPoolModifyRequest', function() {
      // uncomment below and update the code to test CephPoolModifyRequest
      //var instane = new Onepanel.CephPoolModifyRequest();
      //expect(instance).to.be.a(Onepanel.CephPoolModifyRequest);
    });
