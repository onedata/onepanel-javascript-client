...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.Onepanel.OnezoneRedirect = factory(root.Onepanel.ApiClient);
  }
  ...
  /**
   * The OnezoneRedirect model module.
   * @module model/OnezoneRedirect
   * @version 18.02.0-rc2
   */

  /**
   * Constructs a new <code>OnezoneRedirect</code>.
   * Contains URL used for redirecting to Onezone login page.
   * @alias module:model/OnezoneRedirect
   * @class
   * @param url {String} The redirection URL.
   */
   ...
   *
   * @return {module:model/OnezoneRedirect} The value of 'discriminator' field or undefined.
   */
  ...
  /**
   * Constructs a <code>OnezoneRedirect</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/OnezoneRedirect} obj Optional instance to populate.
   * @return {module:model/OnezoneRedirect} The populated <code>OnezoneRedirect</code> instance.
   */
