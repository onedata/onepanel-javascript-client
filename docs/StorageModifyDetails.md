...
**readonly** | **Boolean** | Defines whether storage is readonly. If set to &#x60;true&#x60; it is not possible to write, modify or delete data on the storage. Such storage can only be used to import data into space. | [optional] 
