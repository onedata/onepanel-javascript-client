...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Onepanel.SwiftModify();
  });
  ...
  describe('SwiftModify', function() {
    it('should create an instance of SwiftModify', function() {
      // uncomment below and update the code to test SwiftModify
