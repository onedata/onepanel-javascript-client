...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/StorageCreateDetails', 'model/WebdavCredentials'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./StorageCreateDetails'), require('./WebdavCredentials'));
  } else {
    // Browser globals (root is window)
    if (!root.Onepanel) {
      root.Onepanel = {};
    }
    root.Onepanel.WebdavCreate = factory(root.Onepanel.ApiClient, root.Onepanel.StorageCreateDetails, root.Onepanel.WebdavCredentials);
  }
}(this, function(ApiClient, StorageCreateDetails, WebdavCredentials) {
  'use strict';
   ...
   * @param type {module:model/WebdavCreate.TypeEnum} The type of storage.  `type = \"webdav\"`  Storage backend compatible with [WebDAV](https://tools.ietf.org/html/rfc4918) protocol. 
