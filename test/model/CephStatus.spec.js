...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Onepanel.CephStatus();
  });
  ...
  describe('CephStatus', function() {
    it('should create an instance of CephStatus', function() {
      // uncomment below and update the code to test CephStatus
