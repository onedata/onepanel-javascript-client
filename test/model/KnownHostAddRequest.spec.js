...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Onepanel.KnownHostAddRequest();
  });
  ...
  describe('KnownHostAddRequest', function() {
    it('should create an instance of KnownHostAddRequest', function() {
      // uncomment below and update the code to test KnownHostAddRequest
      //var instane = new Onepanel.KnownHostAddRequest();
      //expect(instance).to.be.a(Onepanel.KnownHostAddRequest);
    });
