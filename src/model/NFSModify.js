...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.Onepanel.NFSModify = factory(root.Onepanel.ApiClient, root.Onepanel.StorageModifyDetails);
  }
  ...
  /**
   * The NFSModify model module.
   * @module model/NFSModify
   * @version 21.02.0-alpha27
   */

  /**
   * Constructs a new <code>NFSModify</code>.
   ...
   *
   * @return {module:model/NFSModify} The value of 'discriminator' field or undefined.
   */
  ...
  /**
   * Constructs a <code>NFSModify</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/NFSModify} obj Optional instance to populate.
   * @return {module:model/NFSModify} The populated <code>NFSModify</code> instance.
   */
