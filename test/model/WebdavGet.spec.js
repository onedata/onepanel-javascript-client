...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Onepanel.WebdavGet();
  });
  ...
  describe('WebdavGet', function() {
    it('should create an instance of WebdavGet', function() {
      // uncomment below and update the code to test WebdavGet
      //var instane = new Onepanel.WebdavGet();
      //expect(instance).to.be.a(Onepanel.WebdavGet);
    });
