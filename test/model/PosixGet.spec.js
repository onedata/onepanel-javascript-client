...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Onepanel.PosixGet();
  });
  ...
  describe('PosixGet', function() {
    it('should create an instance of PosixGet', function() {
      // uncomment below and update the code to test PosixGet
      //var instane = new Onepanel.PosixGet();
      //expect(instance).to.be.a(Onepanel.PosixGet);
    });
