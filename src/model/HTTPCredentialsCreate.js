...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.Onepanel.HTTPCredentialsCreate = factory(root.Onepanel.ApiClient);
  }
  ...
  /**
   * The HTTPCredentialsCreate model module.
   * @module model/HTTPCredentialsCreate
   * @version 20.02.1
   */

  /**
   * Constructs a new <code>HTTPCredentialsCreate</code>.
   * @alias module:model/HTTPCredentialsCreate
   * @class
   */
   ...
   *
   * @return {module:model/HTTPCredentialsCreate} The value of 'discriminator' field or undefined.
   */
  ...
  /**
   * Constructs a <code>HTTPCredentialsCreate</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/HTTPCredentialsCreate} obj Optional instance to populate.
   * @return {module:model/HTTPCredentialsCreate} The populated <code>HTTPCredentialsCreate</code> instance.
   */
