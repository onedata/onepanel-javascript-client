...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.Onepanel.HTTPCommon = factory(root.Onepanel.ApiClient);
  }
  ...
  /**
   * The HTTPCommon model module.
   * @module model/HTTPCommon
   * @version 20.02.1
   */

  /**
   * Constructs a new <code>HTTPCommon</code>.
   * The HTTP storage configuration.
   * @alias module:model/HTTPCommon
   * @class
   */
   ...
   *
   * @return {module:model/HTTPCommon} The value of 'discriminator' field or undefined.
   */
  ...
  /**
   * Constructs a <code>HTTPCommon</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/HTTPCommon} obj Optional instance to populate.
   * @return {module:model/HTTPCommon} The populated <code>HTTPCommon</code> instance.
   */
