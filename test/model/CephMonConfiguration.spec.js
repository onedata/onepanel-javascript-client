...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Onepanel.CephMonConfiguration();
  });
  ...
  describe('CephMonConfiguration', function() {
    it('should create an instance of CephMonConfiguration', function() {
      // uncomment below and update the code to test CephMonConfiguration
      //var instane = new Onepanel.CephMonConfiguration();
      //expect(instance).to.be.a(Onepanel.CephMonConfiguration);
    });
