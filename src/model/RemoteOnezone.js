...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.Onepanel.RemoteOnezone = factory(root.Onepanel.ApiClient);
  }
  ...
  /**
   * The RemoteOnezone model module.
   * @module model/RemoteOnezone
   * @version 18.02.0-rc13
   */

  /**
   * Constructs a new <code>RemoteOnezone</code>.
   * Information which can be obtained about remote Onezone.
   * @alias module:model/RemoteOnezone
   * @class
   ...
   *
   * @return {module:model/RemoteOnezone} The value of 'discriminator' field or undefined.
   */
  ...
  /**
   * Constructs a <code>RemoteOnezone</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/RemoteOnezone} obj Optional instance to populate.
   * @return {module:model/RemoteOnezone} The populated <code>RemoteOnezone</code> instance.
   */
