...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Onepanel.ZoneConfigurationDetails();
  });
  ...
  describe('ZoneConfigurationDetails', function() {
    it('should create an instance of ZoneConfigurationDetails', function() {
      // uncomment below and update the code to test ZoneConfigurationDetails
      //var instane = new Onepanel.ZoneConfigurationDetails();
      //expect(instance).to.be.a(Onepanel.ZoneConfigurationDetails);
    });
