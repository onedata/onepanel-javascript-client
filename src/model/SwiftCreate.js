...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/StorageCommonPathTypeFlat', 'model/StorageCreateDetails', 'model/SwiftCommon', 'model/SwiftCredentials'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./StorageCommonPathTypeFlat'), require('./StorageCreateDetails'), require('./SwiftCommon'), require('./SwiftCredentials'));
  } else {
    // Browser globals (root is window)
    if (!root.Onepanel) {
      root.Onepanel = {};
    }
    root.Onepanel.SwiftCreate = factory(root.Onepanel.ApiClient, root.Onepanel.StorageCommonPathTypeFlat, root.Onepanel.StorageCreateDetails, root.Onepanel.SwiftCommon, root.Onepanel.SwiftCredentials);
  }
}(this, function(ApiClient, StorageCommonPathTypeFlat, StorageCreateDetails, SwiftCommon, SwiftCredentials) {
  'use strict';
