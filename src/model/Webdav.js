...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/StorageCommonPathTypeCanonical', 'model/StorageGetDetails', 'model/WebdavCommon', 'model/WebdavCredentials', 'model/WebdavCredentialsGet'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./StorageCommonPathTypeCanonical'), require('./StorageGetDetails'), require('./WebdavCommon'), require('./WebdavCredentials'), require('./WebdavCredentialsGet'));
  } else {
    // Browser globals (root is window)
    if (!root.Onepanel) {
      root.Onepanel = {};
    }
    root.Onepanel.Webdav = factory(root.Onepanel.ApiClient, root.Onepanel.StorageCommonPathTypeCanonical, root.Onepanel.StorageGetDetails, root.Onepanel.WebdavCommon, root.Onepanel.WebdavCredentials, root.Onepanel.WebdavCredentialsGet);
  }
}(this, function(ApiClient, StorageCommonPathTypeCanonical, StorageGetDetails, WebdavCommon, WebdavCredentials, WebdavCredentialsGet) {
  'use strict';
...
exports.prototype['credentials'] = undefined;
  ...
  // Implement WebdavCredentialsGet interface:
  /**
