...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.Onepanel.XRootDCommon = factory(root.Onepanel.ApiClient);
  }
  ...
  /**
   * The XRootDCommon model module.
   * @module model/XRootDCommon
   * @version 20.02.1
   */

  /**
   * Constructs a new <code>XRootDCommon</code>.
   * The XRootD storage configuration.
   * @alias module:model/XRootDCommon
   * @class
   */
   ...
   *
   * @return {module:model/XRootDCommon} The value of 'discriminator' field or undefined.
   */
  ...
  /**
   * Constructs a <code>XRootDCommon</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/XRootDCommon} obj Optional instance to populate.
   * @return {module:model/XRootDCommon} The populated <code>XRootDCommon</code> instance.
   */
