...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/StorageGetDetails', 'model/WebdavCredentials'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./StorageGetDetails'), require('./WebdavCredentials'));
  } else {
    // Browser globals (root is window)
    if (!root.Onepanel) {
      root.Onepanel = {};
    }
    root.Onepanel.WebdavGet = factory(root.Onepanel.ApiClient, root.Onepanel.StorageGetDetails, root.Onepanel.WebdavCredentials);
  }
}(this, function(ApiClient, StorageGetDetails, WebdavCredentials) {
  'use strict';
  ...
  /**
   * The WebdavGet model module.
   * @module model/WebdavGet
   * @version 21.02.8
   */

  /**
   * Constructs a new <code>WebdavGet</code>.
   * The WebDAV storage configuration.
   * @alias module:model/WebdavGet
   * @class
   * @extends module:model/StorageGetDetails
   * @implements module:model/WebdavCredentials
   * @param type {module:model/WebdavGet.TypeEnum} The type of storage.  `type = \"webdav\"`  Storage backend compatible with [WebDAV](https://tools.ietf.org/html/rfc4918) protocol. 
   ...
   *
   * @return {module:model/WebdavGet} The value of 'discriminator' field or undefined.
   */
  ...
  /**
   * Constructs a <code>WebdavGet</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/WebdavGet} obj Optional instance to populate.
   * @return {module:model/WebdavGet} The populated <code>WebdavGet</code> instance.
   */
   ...
   * @member {module:model/WebdavGet.TypeEnum} type
   */
   ...
   * @member {module:model/WebdavGet.RangeWriteSupportEnum} rangeWriteSupport
   */
   ...
   * @member {module:model/WebdavGet.StoragePathTypeEnum} storagePathType
   */
