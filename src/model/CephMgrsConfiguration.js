...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/CephMgrConfiguration'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./CephMgrConfiguration'));
  } else {
    // Browser globals (root is window)
    if (!root.Onepanel) {
      root.Onepanel = {};
    }
    root.Onepanel.CephMgrsConfiguration = factory(root.Onepanel.ApiClient, root.Onepanel.CephMgrConfiguration);
  }
}(this, function(ApiClient, CephMgrConfiguration) {
  'use strict';
  ...
  /**
   * The CephMgrsConfiguration model module.
   * @module model/CephMgrsConfiguration
   * @version 18.02.0-rc2
   */

  /**
   * Constructs a new <code>CephMgrsConfiguration</code>.
   * 
   * @alias module:model/CephMgrsConfiguration
   * @class
   * @param mgrs {Array.<module:model/CephMgrConfiguration>} @fixme
   */
  var exports = function(mgrs) {
    var _this = this;
   ...
   *
   * @return {module:model/CephMgrsConfiguration} The value of 'discriminator' field or undefined.
   */
  ...
  /**
   * Constructs a <code>CephMgrsConfiguration</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/CephMgrsConfiguration} obj Optional instance to populate.
   * @return {module:model/CephMgrsConfiguration} The populated <code>CephMgrsConfiguration</code> instance.
   */
