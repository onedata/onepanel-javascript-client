...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.Onepanel.HTTPCredentialsGet = factory(root.Onepanel.ApiClient);
  }
  ...
  /**
   * The HTTPCredentialsGet model module.
   * @module model/HTTPCredentialsGet
   * @version 20.02.1
   */

  /**
   * Constructs a new <code>HTTPCredentialsGet</code>.
   * @alias module:model/HTTPCredentialsGet
   * @class
   */
   ...
   *
   * @return {module:model/HTTPCredentialsGet} The value of 'discriminator' field or undefined.
   */
  ...
  /**
   * Constructs a <code>HTTPCredentialsGet</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/HTTPCredentialsGet} obj Optional instance to populate.
   * @return {module:model/HTTPCredentialsGet} The populated <code>HTTPCredentialsGet</code> instance.
   */
