...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.Onepanel.UserModifyRequest = factory(root.Onepanel.ApiClient);
  }
  ...
  /**
   * The UserModifyRequest model module.
   * @module model/UserModifyRequest
   * @version 18.02.0-beta1
   */

  /**
   * Constructs a new <code>UserModifyRequest</code>.
   ...
   *
   * @return {module:model/UserModifyRequest} The value of 'discriminator' field or undefined.
   */
  ...
  /**
   * Constructs a <code>UserModifyRequest</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/UserModifyRequest} obj Optional instance to populate.
   * @return {module:model/UserModifyRequest} The populated <code>UserModifyRequest</code> instance.
   */
