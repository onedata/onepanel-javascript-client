...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Onepanel.WebCertModifyRequest();
  });
  ...
  describe('WebCertModifyRequest', function() {
    it('should create an instance of WebCertModifyRequest', function() {
      // uncomment below and update the code to test WebCertModifyRequest
