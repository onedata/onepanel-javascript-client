...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/CephPool', 'model/LocalcephCommon', 'model/StorageCommonPathTypeFlat', 'model/StorageCreateDetails'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./CephPool'), require('./LocalcephCommon'), require('./StorageCommonPathTypeFlat'), require('./StorageCreateDetails'));
  } else {
    // Browser globals (root is window)
    if (!root.Onepanel) {
      root.Onepanel = {};
    }
    root.Onepanel.LocalcephCreate = factory(root.Onepanel.ApiClient, root.Onepanel.CephPool, root.Onepanel.LocalcephCommon, root.Onepanel.StorageCommonPathTypeFlat, root.Onepanel.StorageCreateDetails);
  }
}(this, function(ApiClient, CephPool, LocalcephCommon, StorageCommonPathTypeFlat, StorageCreateDetails) {
  'use strict';
  ...
  /**
   * The LocalcephCreate model module.
   * @module model/LocalcephCreate
   * @version 20.02.1
   */

  /**
   * Constructs a new <code>LocalcephCreate</code>.
   * Configuration of a Ceph (librados) storage backed by a Ceph pool created in the local Ceph cluster.
   * @alias module:model/LocalcephCreate
   * @class
   ...
   *
   * @return {module:model/LocalcephCreate} The value of 'discriminator' field or undefined.
   */
  ...
  /**
   * Constructs a <code>LocalcephCreate</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/LocalcephCreate} obj Optional instance to populate.
   * @return {module:model/LocalcephCreate} The populated <code>LocalcephCreate</code> instance.
   */
