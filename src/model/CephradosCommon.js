...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.Onepanel.CephradosCommon = factory(root.Onepanel.ApiClient);
  }
  ...
  /**
   * The CephradosCommon model module.
   * @module model/CephradosCommon
   * @version 20.02.1
   */

  /**
   * Constructs a new <code>CephradosCommon</code>.
   * The Ceph storage configuration (uses librados).
   * @alias module:model/CephradosCommon
   * @class
   */
   ...
   *
   * @return {module:model/CephradosCommon} The value of 'discriminator' field or undefined.
   */
  ...
  /**
   * Constructs a <code>CephradosCommon</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/CephradosCommon} obj Optional instance to populate.
   * @return {module:model/CephradosCommon} The populated <code>CephradosCommon</code> instance.
   */
