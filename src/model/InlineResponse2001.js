...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.Onepanel.InlineResponse2001 = factory(root.Onepanel.ApiClient, root.Onepanel.DnsCheckResult);
  }
   ...
   * Results of the DNS checks for domain (A records) and zone delegation (NS and SOA records).
   * @alias module:model/InlineResponse2001
   * @class
   * @param domain {module:model/DnsCheckResult} 
   * @param dnsZone {module:model/DnsCheckResult} 
   */
  var exports = function(domain, dnsZone) {
    var _this = this;

    _this['domain'] = domain;
    _this['dnsZone'] = dnsZone;
  };
   ...
   *
   * @return {module:model/InlineResponse2001} The value of 'discriminator' field or undefined.
   */
