...
(function(root, factory) {
   ...
   * Filestore OSD specification. Filestore means OSD is backed by a folder on an existing filesystem.
   ...
   * @param type {module:model/Filestore.TypeEnum} Type of the OSD. Available types are: - filestore - stores all files on an existing filesystem - bluestore - formats a raw block device to store the data 
   */
   ...
   * @member {module:model/Filestore.TypeEnum} type
   */
