...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.Onepanel.OnezoneUserCreateRequest = factory(root.Onepanel.ApiClient);
  }
  ...
  /**
   * The OnezoneUserCreateRequest model module.
   * @module model/OnezoneUserCreateRequest
   * @version 18.02.1
   */
   ...
   *
   * @return {module:model/OnezoneUserCreateRequest} The value of 'discriminator' field or undefined.
   */
  ...
  /**
   * Constructs a <code>OnezoneUserCreateRequest</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/OnezoneUserCreateRequest} obj Optional instance to populate.
   * @return {module:model/OnezoneUserCreateRequest} The populated <code>OnezoneUserCreateRequest</code> instance.
   */
