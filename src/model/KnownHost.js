...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.Onepanel.KnownHost = factory(root.Onepanel.ApiClient);
  }
  ...
  /**
   * The KnownHost model module.
   * @module model/KnownHost
   * @version 17.06.0-rc2
   */

  /**
   * Constructs a new <code>KnownHost</code>.
   * Details of a host available for clustering.
   * @alias module:model/KnownHost
   * @class
   * @param hostname {String} Erlang hostname of the node.
   */
   ...
   *
   * @return {module:model/KnownHost} The value of 'discriminator' field or undefined.
   */
  ...
  /**
   * Constructs a <code>KnownHost</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/KnownHost} obj Optional instance to populate.
   * @return {module:model/KnownHost} The populated <code>KnownHost</code> instance.
   */
