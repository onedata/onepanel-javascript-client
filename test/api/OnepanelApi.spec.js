...
(function(root, factory) {
  ...
  describe('OnepanelApi', function() {
    describe('deleteHostsHost', function() {
      it('should call deleteHostsHost successfully', function(done) {
        //uncomment below and update the code to test deleteHostsHost
        //instance.deleteHostsHost(function(error) {
    ...
    describe('deleteUsersUsername', function() {
      it('should call deleteUsersUsername successfully', function(done) {
        //uncomment below and update the code to test deleteUsersUsername
        //instance.deleteUsersUsername(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('getCookie', function() {
      it('should call getCookie successfully', function(done) {
        //uncomment below and update the code to test getCookie
        //instance.getCookie(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('getHosts', function() {
      it('should call getHosts successfully', function(done) {
        //uncomment below and update the code to test getHosts
        //instance.getHosts(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('getUsersUsername', function() {
      it('should call getUsersUsername successfully', function(done) {
        //uncomment below and update the code to test getUsersUsername
        //instance.getUsersUsername(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('patchUsersUsername', function() {
      it('should call patchUsersUsername successfully', function(done) {
        //uncomment below and update the code to test patchUsersUsername
        //instance.patchUsersUsername(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('postHosts', function() {
      it('should call postHosts successfully', function(done) {
        //uncomment below and update the code to test postHosts
        //instance.postHosts(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
