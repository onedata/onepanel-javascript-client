...
(function(root, factory) {
  ...
  describe('NFSGet', function() {
    it('should create an instance of NFSGet', function() {
      // uncomment below and update the code to test NFSGet
      //var instane = new Onepanel.NFSGet();
      //expect(instance).to.be.a(Onepanel.NFSGet);
    });
