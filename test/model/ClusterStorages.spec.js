...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Onepanel.ClusterStorages();
  });
  ...
  describe('ClusterStorages', function() {
    it('should create an instance of ClusterStorages', function() {
      // uncomment below and update the code to test ClusterStorages
      //var instane = new Onepanel.ClusterStorages();
      //expect(instance).to.be.a(Onepanel.ClusterStorages);
    });
