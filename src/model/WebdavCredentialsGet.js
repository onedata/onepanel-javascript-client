...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.Onepanel.WebdavCredentialsGet = factory(root.Onepanel.ApiClient);
  }
  ...
  /**
   * The WebdavCredentialsGet model module.
   * @module model/WebdavCredentialsGet
   * @version 20.02.1
   */

  /**
   * Constructs a new <code>WebdavCredentialsGet</code>.
   * @alias module:model/WebdavCredentialsGet
   * @class
   */
   ...
   *
   * @return {module:model/WebdavCredentialsGet} The value of 'discriminator' field or undefined.
   */
  ...
  /**
   * Constructs a <code>WebdavCredentialsGet</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/WebdavCredentialsGet} obj Optional instance to populate.
   * @return {module:model/WebdavCredentialsGet} The populated <code>WebdavCredentialsGet</code> instance.
   */
