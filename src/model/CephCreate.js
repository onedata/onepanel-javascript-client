...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/CephCommon', 'model/CephCredentials', 'model/StorageCommonPathTypeFlat', 'model/StorageCreateDetails'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./CephCommon'), require('./CephCredentials'), require('./StorageCommonPathTypeFlat'), require('./StorageCreateDetails'));
  } else {
    // Browser globals (root is window)
    if (!root.Onepanel) {
      root.Onepanel = {};
    }
    root.Onepanel.CephCreate = factory(root.Onepanel.ApiClient, root.Onepanel.CephCommon, root.Onepanel.CephCredentials, root.Onepanel.StorageCommonPathTypeFlat, root.Onepanel.StorageCreateDetails);
  }
}(this, function(ApiClient, CephCommon, CephCredentials, StorageCommonPathTypeFlat, StorageCreateDetails) {
  'use strict';
  ...
  /**
   * The CephCreate model module.
   * @module model/CephCreate
   * @version 20.02.1
   */

  /**
   * Constructs a new <code>CephCreate</code>.
   * The Ceph storage configuration (uses libradosstriper).
   * @alias module:model/CephCreate
   * @class
   ...
   *
   * @return {module:model/CephCreate} The value of 'discriminator' field or undefined.
   */
  ...
  /**
   * Constructs a <code>CephCreate</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/CephCreate} obj Optional instance to populate.
   * @return {module:model/CephCreate} The populated <code>CephCreate</code> instance.
   */
