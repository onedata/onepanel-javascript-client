...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.Onepanel.GlusterfsCommon = factory(root.Onepanel.ApiClient);
  }
  ...
  /**
   * The GlusterfsCommon model module.
   * @module model/GlusterfsCommon
   * @version 20.02.1
   */

  /**
   * Constructs a new <code>GlusterfsCommon</code>.
   * The GlusterFS storage configuration.
   * @alias module:model/GlusterfsCommon
   * @class
   ...
   *
   * @return {module:model/GlusterfsCommon} The value of 'discriminator' field or undefined.
   */
  ...
  /**
   * Constructs a <code>GlusterfsCommon</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/GlusterfsCommon} obj Optional instance to populate.
   * @return {module:model/GlusterfsCommon} The populated <code>GlusterfsCommon</code> instance.
   */
