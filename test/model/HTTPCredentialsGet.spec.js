...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Onepanel.HTTPCredentialsGet();
  });
  ...
  describe('HTTPCredentialsGet', function() {
    it('should create an instance of HTTPCredentialsGet', function() {
      // uncomment below and update the code to test HTTPCredentialsGet
      //var instane = new Onepanel.HTTPCredentialsGet();
      //expect(instance).to.be.a(Onepanel.HTTPCredentialsGet);
    });
