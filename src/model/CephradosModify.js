...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.Onepanel.CephradosModify = factory(root.Onepanel.ApiClient, root.Onepanel.StorageDetailsModify);
  }
  ...
  /**
   * The CephradosModify model module.
   * @module model/CephradosModify
   * @version 18.02.1
   */
   ...
   *
   * @return {module:model/CephradosModify} The value of 'discriminator' field or undefined.
   */
  ...
  /**
   * Constructs a <code>CephradosModify</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/CephradosModify} obj Optional instance to populate.
   * @return {module:model/CephradosModify} The populated <code>CephradosModify</code> instance.
   */
