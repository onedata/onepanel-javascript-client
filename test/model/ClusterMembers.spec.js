...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Onepanel.ClusterMembers();
  });
  ...
  describe('ClusterMembers', function() {
    it('should create an instance of ClusterMembers', function() {
      // uncomment below and update the code to test ClusterMembers
