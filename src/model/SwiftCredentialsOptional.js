...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.Onepanel.SwiftCredentialsOptional = factory(root.Onepanel.ApiClient, root.Onepanel.LumaStorageCredentials);
  }
  ...
  /**
   * The SwiftCredentialsOptional model module.
   * @module model/SwiftCredentialsOptional
   * @version 20.02.1
   */

  /**
   * Constructs a new <code>SwiftCredentialsOptional</code>.
   * Credentials on the SWIFT storage.
   * @alias module:model/SwiftCredentialsOptional
   * @class
   ...
   *
   * @return {module:model/SwiftCredentialsOptional} The value of 'discriminator' field or undefined.
   */
  ...
  /**
   * Constructs a <code>SwiftCredentialsOptional</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/SwiftCredentialsOptional} obj Optional instance to populate.
   * @return {module:model/SwiftCredentialsOptional} The populated <code>SwiftCredentialsOptional</code> instance.
   */
