...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Onepanel.CephradosCommon();
  });
  ...
  describe('CephradosCommon', function() {
    it('should create an instance of CephradosCommon', function() {
      // uncomment below and update the code to test CephradosCommon
      //var instane = new Onepanel.CephradosCommon();
      //expect(instance).to.be.a(Onepanel.CephradosCommon);
    });
