...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.Onepanel.ClusterMembers = factory(root.Onepanel.ApiClient);
  }
  ...
  /**
   * The ClusterMembers model module.
   * @module model/ClusterMembers
   * @version 18.02.1
   */

  /**
   * Constructs a new <code>ClusterMembers</code>.
   * Summary of cluster members, listing number of direct and effective users and groups.
   * @alias module:model/ClusterMembers
   * @class
   */
   ...
   *
   * @return {module:model/ClusterMembers} The value of 'discriminator' field or undefined.
   */
  ...
  /**
   * Constructs a <code>ClusterMembers</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/ClusterMembers} obj Optional instance to populate.
   * @return {module:model/ClusterMembers} The populated <code>ClusterMembers</code> instance.
   */
