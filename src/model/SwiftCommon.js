...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.Onepanel.SwiftCommon = factory(root.Onepanel.ApiClient);
  }
  ...
  /**
   * The SwiftCommon model module.
   * @module model/SwiftCommon
   * @version 20.02.1
   */

  /**
   * Constructs a new <code>SwiftCommon</code>.
   * The OpenStack Swift configuration.
   * @alias module:model/SwiftCommon
   * @class
   */
   ...
   *
   * @return {module:model/SwiftCommon} The value of 'discriminator' field or undefined.
   */
  ...
  /**
   * Constructs a <code>SwiftCommon</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/SwiftCommon} obj Optional instance to populate.
   * @return {module:model/SwiftCommon} The populated <code>SwiftCommon</code> instance.
   */
