...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Onepanel.CephPoolStorageParams();
  });
  ...
  describe('CephPoolStorageParams', function() {
    it('should create an instance of CephPoolStorageParams', function() {
      // uncomment below and update the code to test CephPoolStorageParams
      //var instane = new Onepanel.CephPoolStorageParams();
      //expect(instance).to.be.a(Onepanel.CephPoolStorageParams);
    });
