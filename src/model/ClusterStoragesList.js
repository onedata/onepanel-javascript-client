...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.Onepanel.ClusterStoragesList = factory(root.Onepanel.ApiClient, root.Onepanel.ClusterStorages);
  }
  ...
  /**
   * The ClusterStoragesList model module.
   * @module model/ClusterStoragesList
   * @version 3.0.0-rc11
   */

  /**
   * Constructs a new <code>ClusterStoragesList</code>.
   * The list of supported storage types.
   * @alias module:model/ClusterStoragesList
   * @class
   * @extends Object
   */
   ...
   *
   * @return {module:model/ClusterStoragesList} The value of 'discriminator' field or undefined.
   */
  ...
  /**
   * Constructs a <code>ClusterStoragesList</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/ClusterStoragesList} obj Optional instance to populate.
   * @return {module:model/ClusterStoragesList} The populated <code>ClusterStoragesList</code> instance.
   */
  exports.constructFromObject = function(data, obj) {
    if (data) {
      obj = obj || new exports();
      ApiClient.constructFromObject(data, obj, 'ClusterStorages');
