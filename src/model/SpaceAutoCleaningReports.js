...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.Onepanel.SpaceAutoCleaningReports = factory(root.Onepanel.ApiClient);
  }
  ...
  /**
   * The SpaceAutoCleaningReports model module.
   * @module model/SpaceAutoCleaningReports
   * @version 19.02.0-beta1
   */

  /**
   * Constructs a new <code>SpaceAutoCleaningReports</code>.
   * The space auto-cleaning reports.
   * @alias module:model/SpaceAutoCleaningReports
   * @class
   * @param ids {Array.<String>} The list of Ids of space auto-cleaning reports.
   */
   ...
   *
   * @return {module:model/SpaceAutoCleaningReports} The value of 'discriminator' field or undefined.
   */
  ...
  /**
   * Constructs a <code>SpaceAutoCleaningReports</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/SpaceAutoCleaningReports} obj Optional instance to populate.
   * @return {module:model/SpaceAutoCleaningReports} The populated <code>SpaceAutoCleaningReports</code> instance.
   */
