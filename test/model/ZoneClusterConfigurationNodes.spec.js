...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Onepanel.ZoneClusterConfigurationNodes();
  });
  ...
  describe('ZoneClusterConfigurationNodes', function() {
    it('should create an instance of ZoneClusterConfigurationNodes', function() {
      // uncomment below and update the code to test ZoneClusterConfigurationNodes
      //var instane = new Onepanel.ZoneClusterConfigurationNodes();
      //expect(instance).to.be.a(Onepanel.ZoneClusterConfigurationNodes);
    });
