...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.Onepanel.ProviderConfigurationDetailsOneprovider = factory(root.Onepanel.ApiClient);
  }
  ...
  /**
   * The ProviderConfigurationDetailsOneprovider model module.
   * @module model/ProviderConfigurationDetailsOneprovider
   * @version 19.02.0-beta1
   */

  /**
   * Constructs a new <code>ProviderConfigurationDetailsOneprovider</code>.
   ...
   *
   * @return {module:model/ProviderConfigurationDetailsOneprovider} The value of 'discriminator' field or undefined.
   */
  ...
  /**
   * Constructs a <code>ProviderConfigurationDetailsOneprovider</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/ProviderConfigurationDetailsOneprovider} obj Optional instance to populate.
   * @return {module:model/ProviderConfigurationDetailsOneprovider} The populated <code>ProviderConfigurationDetailsOneprovider</code> instance.
   */
