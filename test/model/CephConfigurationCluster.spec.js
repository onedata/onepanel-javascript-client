...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Onepanel.CephConfigurationCluster();
  });
  ...
  describe('CephConfigurationCluster', function() {
    it('should create an instance of CephConfigurationCluster', function() {
      // uncomment below and update the code to test CephConfigurationCluster
      //var instane = new Onepanel.CephConfigurationCluster();
      //expect(instance).to.be.a(Onepanel.CephConfigurationCluster);
    });
