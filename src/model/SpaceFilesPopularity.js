...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.Onepanel.SpaceFilesPopularity = factory(root.Onepanel.ApiClient);
  }
  ...
  /**
   * The SpaceFilesPopularity model module.
   * @module model/SpaceFilesPopularity
   * @version 18.02.0-beta1
   */

  /**
   * Constructs a new <code>SpaceFilesPopularity</code>.
   * Settings of files popularity feature of space
   * @alias module:model/SpaceFilesPopularity
   * @class
   ...
   *
   * @return {module:model/SpaceFilesPopularity} The value of 'discriminator' field or undefined.
   */
  ...
  /**
   * Constructs a <code>SpaceFilesPopularity</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/SpaceFilesPopularity} obj Optional instance to populate.
   * @return {module:model/SpaceFilesPopularity} The populated <code>SpaceFilesPopularity</code> instance.
   */
