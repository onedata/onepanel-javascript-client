...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.Onepanel.NulldeviceCommon = factory(root.Onepanel.ApiClient);
  }
  ...
  /**
   * The NulldeviceCommon model module.
   * @module model/NulldeviceCommon
   * @version 20.02.1
   */

  /**
   * Constructs a new <code>NulldeviceCommon</code>.
   * The Null Device storage configuration.
   * @alias module:model/NulldeviceCommon
   * @class
   ...
   *
   * @return {module:model/NulldeviceCommon} The value of 'discriminator' field or undefined.
   */
  ...
  /**
   * Constructs a <code>NulldeviceCommon</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/NulldeviceCommon} obj Optional instance to populate.
   * @return {module:model/NulldeviceCommon} The populated <code>NulldeviceCommon</code> instance.
   */
