...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.Onepanel.KnownHostAddRequest = factory(root.Onepanel.ApiClient);
  }
  ...
  /**
   * The KnownHostAddRequest model module.
   * @module model/KnownHostAddRequest
   * @version 17.06.0-rc2
   */

  /**
   * Constructs a new <code>KnownHostAddRequest</code>.
   * Details of host added for future clustering
   * @alias module:model/KnownHostAddRequest
   * @class
   ...
   *
   * @return {module:model/KnownHostAddRequest} The value of 'discriminator' field or undefined.
   */
  ...
  /**
   * Constructs a <code>KnownHostAddRequest</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/KnownHostAddRequest} obj Optional instance to populate.
   * @return {module:model/KnownHostAddRequest} The populated <code>KnownHostAddRequest</code> instance.
   */
