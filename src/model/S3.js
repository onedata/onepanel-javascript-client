...
(function(root, factory) {
   ...
   * @param s3Hostname {String} The hostname of a machine where S3 storage is installed.
   * @param iamHostname {String} The IAM hostname for the S3 storage.
   ...
   */
  var exports = function(type, s3Hostname, iamHostname, bucketName, accessKey, secretKey) {
    var _this = this;
    ClusterStorages.call(_this, type);
    _this['s3Hostname'] = s3Hostname;
    _this['iamHostname'] = iamHostname;
  ...
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('s3Hostname')) {
        obj['s3Hostname'] = ApiClient.convertToType(data['s3Hostname'], 'String');
      }
      if (data.hasOwnProperty('iamHostname')) {
        obj['iamHostname'] = ApiClient.convertToType(data['iamHostname'], 'String');
      }
   ...
   * @member {String} s3Hostname
   */
  exports.prototype['s3Hostname'] = undefined;
  /**
   * The IAM hostname for the S3 storage.
   * @member {String} iamHostname
   */
  exports.prototype['iamHostname'] = undefined;
  /**
