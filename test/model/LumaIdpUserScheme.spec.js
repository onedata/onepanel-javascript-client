...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Onepanel.LumaIdpUserScheme();
  });
  ...
  describe('LumaIdpUserScheme', function() {
    it('should create an instance of LumaIdpUserScheme', function() {
      // uncomment below and update the code to test LumaIdpUserScheme
      //var instane = new Onepanel.LumaIdpUserScheme();
      //expect(instance).to.be.a(Onepanel.LumaIdpUserScheme);
    });
