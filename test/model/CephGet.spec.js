...
(function(root, factory) {
  ...
  describe('CephGet', function() {
    it('should create an instance of CephGet', function() {
      // uncomment below and update the code to test CephGet
      //var instane = new Onepanel.CephGet();
      //expect(instance).to.be.a(Onepanel.CephGet);
    });
