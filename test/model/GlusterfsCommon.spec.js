...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Onepanel.GlusterfsCommon();
  });
  ...
  describe('GlusterfsCommon', function() {
    it('should create an instance of GlusterfsCommon', function() {
      // uncomment below and update the code to test GlusterfsCommon
      //var instane = new Onepanel.GlusterfsCommon();
      //expect(instance).to.be.a(Onepanel.GlusterfsCommon);
    });
