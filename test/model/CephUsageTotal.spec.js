...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Onepanel.CephUsageTotal();
  });
  ...
  describe('CephUsageTotal', function() {
    it('should create an instance of CephUsageTotal', function() {
      // uncomment below and update the code to test CephUsageTotal
      //var instane = new Onepanel.CephUsageTotal();
      //expect(instance).to.be.a(Onepanel.CephUsageTotal);
    });
