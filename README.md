...
- API version: 19.02.0-rc1
- Package version: 19.02.0-rc1
...
*Onepanel.OnezoneApi* | [**getGuiMessage**](docs/OnezoneApi.md#getGuiMessage) | **GET** /zone/gui_message/{id} | Get settings of a Onezone GUI message.
...
*Onepanel.OnezoneApi* | [**modifyGuiMessage**](docs/OnezoneApi.md#modifyGuiMessage) | **PATCH** /zone/gui_message/{id} | Modify settings of a Onezone GUI message.
