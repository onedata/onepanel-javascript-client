...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.Onepanel.QosParametersChangeRequest = factory(root.Onepanel.ApiClient);
  }
  ...
  /**
   * The QosParametersChangeRequest model module.
   * @module model/QosParametersChangeRequest
   * @version 18.02.1
   */

  /**
   * Constructs a new <code>QosParametersChangeRequest</code>.
   * @FIXME
   * @alias module:model/QosParametersChangeRequest
   * @class
   */
   ...
   *
   * @return {module:model/QosParametersChangeRequest} The value of 'discriminator' field or undefined.
   */
  ...
  /**
   * Constructs a <code>QosParametersChangeRequest</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/QosParametersChangeRequest} obj Optional instance to populate.
   * @return {module:model/QosParametersChangeRequest} The populated <code>QosParametersChangeRequest</code> instance.
   */
  ...
  /**
   * Names of parameters to be removed
   * @member {Array.<String>} unset
   */
  exports.prototype['unset'] = undefined;
