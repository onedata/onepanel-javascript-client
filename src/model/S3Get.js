...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/S3Credentials', 'model/StorageGetDetails'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./S3Credentials'), require('./StorageGetDetails'));
  } else {
    // Browser globals (root is window)
    if (!root.Onepanel) {
      root.Onepanel = {};
    }
    root.Onepanel.S3Get = factory(root.Onepanel.ApiClient, root.Onepanel.S3Credentials, root.Onepanel.StorageGetDetails);
  }
}(this, function(ApiClient, S3Credentials, StorageGetDetails) {
  'use strict';
   ...
   * @param type {module:model/S3Get.TypeEnum} The type of storage.  `type = \"s3\"`  [Amazon S3](http://docs.aws.amazon.com/AmazonS3/latest/API/Welcome.html) compatible storage. 
   ...
   *
   * @return {module:model/S3Get} The value of 'discriminator' field or undefined.
   */
  ...
  /**
   * Constructs a <code>S3Get</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/S3Get} obj Optional instance to populate.
   * @return {module:model/S3Get} The populated <code>S3Get</code> instance.
   */
   ...
   * @member {module:model/S3Get.TypeEnum} type
   */
   ...
   * @member {module:model/S3Get.StoragePathTypeEnum} storagePathType
   */
