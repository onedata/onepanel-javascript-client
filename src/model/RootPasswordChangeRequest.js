...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.Onepanel.RootPasswordChangeRequest = factory(root.Onepanel.ApiClient);
  }
  ...
  /**
   * The RootPasswordChangeRequest model module.
   * @module model/RootPasswordChangeRequest
   * @version 18.02.1
   */

  /**
   * Constructs a new <code>RootPasswordChangeRequest</code>.
   * Root password to set.
   * @alias module:model/RootPasswordChangeRequest
   * @class
   */
   ...
   *
   * @return {module:model/RootPasswordChangeRequest} The value of 'discriminator' field or undefined.
   */
  ...
  /**
   * Constructs a <code>RootPasswordChangeRequest</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/RootPasswordChangeRequest} obj Optional instance to populate.
   * @return {module:model/RootPasswordChangeRequest} The populated <code>RootPasswordChangeRequest</code> instance.
   */
