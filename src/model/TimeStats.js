...
(function(root, factory) {
   ...
   * @class
   * @param name {module:model/TimeStats.NameEnum} How many samples were taken in measurement period.
   * @param lastValueDate {String} Date of last measurement value in this object in ISO 8601 format
   * @param period {module:model/TimeStats.PeriodEnum} Predefined time period for which the statistics should be fetched
   ...
   */
  var exports = function(name, lastValueDate, period, values) {
    var _this = this;
  ...
  /**
   * How many samples were taken in measurement period.
