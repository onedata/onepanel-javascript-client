...
*Onepanel.OneproviderApi* | [**stopStorageImportScan**](docs/OneproviderApi.md#stopStorageImportScan) | **POST** /provider/spaces/{id}/sync/stop | Stops storage import scan
