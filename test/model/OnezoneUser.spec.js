...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Onepanel.OnezoneUser();
  });
  ...
  describe('OnezoneUser', function() {
    it('should create an instance of OnezoneUser', function() {
      // uncomment below and update the code to test OnezoneUser
      //var instane = new Onepanel.OnezoneUser();
      //expect(instance).to.be.a(Onepanel.OnezoneUser);
    });
