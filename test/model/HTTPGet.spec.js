...
(function(root, factory) {
  ...
  describe('HTTPGet', function() {
    it('should create an instance of HTTPGet', function() {
      // uncomment below and update the code to test HTTPGet
      //var instane = new Onepanel.HTTPGet();
      //expect(instance).to.be.a(Onepanel.HTTPGet);
    });
