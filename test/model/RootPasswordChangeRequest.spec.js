...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Onepanel.RootPasswordChangeRequest();
  });
  ...
  describe('RootPasswordChangeRequest', function() {
    it('should create an instance of RootPasswordChangeRequest', function() {
      // uncomment below and update the code to test RootPasswordChangeRequest
      //var instane = new Onepanel.RootPasswordChangeRequest();
      //expect(instance).to.be.a(Onepanel.RootPasswordChangeRequest);
    });
