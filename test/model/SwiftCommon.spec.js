...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Onepanel.SwiftCommon();
  });
  ...
  describe('SwiftCommon', function() {
    it('should create an instance of SwiftCommon', function() {
      // uncomment below and update the code to test SwiftCommon
      //var instane = new Onepanel.SwiftCommon();
      //expect(instance).to.be.a(Onepanel.SwiftCommon);
    });
