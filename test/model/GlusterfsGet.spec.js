...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Onepanel.GlusterfsGet();
  });
  ...
  describe('GlusterfsGet', function() {
    it('should create an instance of GlusterfsGet', function() {
      // uncomment below and update the code to test GlusterfsGet
      //var instane = new Onepanel.GlusterfsGet();
      //expect(instance).to.be.a(Onepanel.GlusterfsGet);
    });
