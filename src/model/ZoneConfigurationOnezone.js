...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/ZoneConfigurationOnezoneUsers', 'model/ZonePolicies'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./ZoneConfigurationOnezoneUsers'), require('./ZonePolicies'));
  } else {
    // Browser globals (root is window)
    if (!root.Onepanel) {
      root.Onepanel = {};
    }
    root.Onepanel.ZoneConfigurationOnezone = factory(root.Onepanel.ApiClient, root.Onepanel.ZoneConfigurationOnezoneUsers, root.Onepanel.ZonePolicies);
  }
}(this, function(ApiClient, ZoneConfigurationOnezoneUsers, ZonePolicies) {
  'use strict';
  ...
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('users')) {
        obj['users'] = ApiClient.convertToType(data['users'], [ZoneConfigurationOnezoneUsers]);
      }
    }
    return obj;
  }
  ...
  /**
   * Onezone users to be created.
   * @member {Array.<module:model/ZoneConfigurationOnezoneUsers>} users
   */
