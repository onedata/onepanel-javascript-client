...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Onepanel.S3Common();
  });
  ...
  describe('S3Common', function() {
    it('should create an instance of S3Common', function() {
      // uncomment below and update the code to test S3Common
      //var instane = new Onepanel.S3Common();
      //expect(instance).to.be.a(Onepanel.S3Common);
    });
