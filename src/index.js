...
(function(factory) {
  ...
  var exports = {
    ...
    ApiClient: ApiClient,
    /**
     * The CephConfiguration model constructor.
     * @property {module:model/CephConfiguration}
     */
    CephConfiguration: CephConfiguration,
    /**
     * The CephConfigurationCluster model constructor.
     * @property {module:model/CephConfigurationCluster}
     */
    CephConfigurationCluster: CephConfigurationCluster,
    /**
     * The CephMgrConfiguration model constructor.
     * @property {module:model/CephMgrConfiguration}
     */
    CephMgrConfiguration: CephMgrConfiguration,
    /**
     * The CephMgrsConfiguration model constructor.
     * @property {module:model/CephMgrsConfiguration}
     */
    CephMgrsConfiguration: CephMgrsConfiguration,
    /**
     * The CephMonConfiguration model constructor.
     * @property {module:model/CephMonConfiguration}
     */
    CephMonConfiguration: CephMonConfiguration,
    /**
     * The CephMonsConfiguration model constructor.
     * @property {module:model/CephMonsConfiguration}
     */
    CephMonsConfiguration: CephMonsConfiguration,
    /**
     * The CephOsdConfiguration model constructor.
     * @property {module:model/CephOsdConfiguration}
     */
    CephOsdConfiguration: CephOsdConfiguration,
    /**
    ...
    CephOsds: CephOsds,
    /**
     * The CephOsdsConfiguration model constructor.
     * @property {module:model/CephOsdsConfiguration}
     */
    CephOsdsConfiguration: CephOsdsConfiguration,
    /**
    ...
    CephPool: CephPool,
    /**
     * The CephPoolModifyRequest model constructor.
     * @property {module:model/CephPoolModifyRequest}
     */
    CephPoolModifyRequest: CephPoolModifyRequest,
    /**
     * The CephPoolStorageParams model constructor.
     * @property {module:model/CephPoolStorageParams}
     */
    CephPoolStorageParams: CephPoolStorageParams,
    /**
    ...
    CephUsage: CephUsage,
    /**
     * The CephUsageTotal model constructor.
     * @property {module:model/CephUsageTotal}
     */
    CephUsageTotal: CephUsageTotal,
    /**
