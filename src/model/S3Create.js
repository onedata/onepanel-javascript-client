...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/S3Common', 'model/S3Credentials', 'model/StorageCommonPathTypeFlat', 'model/StorageCreateDetails'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./S3Common'), require('./S3Credentials'), require('./StorageCommonPathTypeFlat'), require('./StorageCreateDetails'));
  } else {
    // Browser globals (root is window)
    if (!root.Onepanel) {
      root.Onepanel = {};
    }
    root.Onepanel.S3Create = factory(root.Onepanel.ApiClient, root.Onepanel.S3Common, root.Onepanel.S3Credentials, root.Onepanel.StorageCommonPathTypeFlat, root.Onepanel.StorageCreateDetails);
  }
}(this, function(ApiClient, S3Common, S3Credentials, StorageCommonPathTypeFlat, StorageCreateDetails) {
  'use strict';
