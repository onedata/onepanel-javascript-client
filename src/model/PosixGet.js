...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.Onepanel.PosixGet = factory(root.Onepanel.ApiClient, root.Onepanel.StorageGetDetails);
  }
  ...
  /**
   * The PosixGet model module.
   * @module model/PosixGet
   * @version 21.02.8
   */

  /**
   * Constructs a new <code>PosixGet</code>.
   * The POSIX storage configuration.
   * @alias module:model/PosixGet
   * @class
   * @extends module:model/StorageGetDetails
   * @param type {module:model/PosixGet.TypeEnum} The type of storage.  `type = \"posix\"`  Any POSIX compatible storage, typically attached over high-throughput local network, such as NFS. 
   ...
   *
   * @return {module:model/PosixGet} The value of 'discriminator' field or undefined.
   */
  ...
  /**
   * Constructs a <code>PosixGet</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/PosixGet} obj Optional instance to populate.
   * @return {module:model/PosixGet} The populated <code>PosixGet</code> instance.
   */
   ...
   * @member {module:model/PosixGet.TypeEnum} type
   */
   ...
   * @member {module:model/PosixGet.StoragePathTypeEnum} storagePathType
   */
