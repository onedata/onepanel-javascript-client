...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.Onepanel.OzConfiguration = factory(root.Onepanel.ApiClient, root.Onepanel.Configuration);
  }
  ...
  /**
   * The OzConfiguration model module.
   * @module model/OzConfiguration
   * @version 18.02.1
   */
   ...
   */
  var exports = function(clusterId, version, build, deployed, serviceType, zoneDomain) {
    var _this = this;
   ...
   *
   * @return {module:model/OzConfiguration} The value of 'discriminator' field or undefined.
   */
  ...
  /**
   * Constructs a <code>OzConfiguration</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/OzConfiguration} obj Optional instance to populate.
   * @return {module:model/OzConfiguration} The populated <code>OzConfiguration</code> instance.
   */
   ...
   * @member {module:model/OzConfiguration.ServiceTypeEnum} serviceType
   */
