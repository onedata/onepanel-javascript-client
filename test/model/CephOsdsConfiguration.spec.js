...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Onepanel.CephOsdsConfiguration();
  });
  ...
  describe('CephOsdsConfiguration', function() {
    it('should create an instance of CephOsdsConfiguration', function() {
      // uncomment below and update the code to test CephOsdsConfiguration
      //var instane = new Onepanel.CephOsdsConfiguration();
      //expect(instance).to.be.a(Onepanel.CephOsdsConfiguration);
    });
