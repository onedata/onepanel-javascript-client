...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/CephCluster', 'model/OpPanelConfiguration', 'model/ProviderClusterConfiguration', 'model/ProviderConfigurationOneprovider'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./CephCluster'), require('./OpPanelConfiguration'), require('./ProviderClusterConfiguration'), require('./ProviderConfigurationOneprovider'));
  } else {
    // Browser globals (root is window)
    if (!root.Onepanel) {
      root.Onepanel = {};
    }
    root.Onepanel.ProviderConfiguration = factory(root.Onepanel.ApiClient, root.Onepanel.CephCluster, root.Onepanel.OpPanelConfiguration, root.Onepanel.ProviderClusterConfiguration, root.Onepanel.ProviderConfigurationOneprovider);
  }
}(this, function(ApiClient, CephCluster, OpPanelConfiguration, ProviderClusterConfiguration, ProviderConfigurationOneprovider) {
  'use strict';
