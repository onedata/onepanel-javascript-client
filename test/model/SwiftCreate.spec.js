...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Onepanel.SwiftCreate();
  });
  ...
  describe('SwiftCreate', function() {
    it('should create an instance of SwiftCreate', function() {
      // uncomment below and update the code to test SwiftCreate
      //var instane = new Onepanel.SwiftCreate();
      //expect(instance).to.be.a(Onepanel.SwiftCreate);
    });
