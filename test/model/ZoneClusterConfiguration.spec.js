...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Onepanel.ZoneClusterConfiguration();
  });
  ...
  describe('ZoneClusterConfiguration', function() {
    it('should create an instance of ZoneClusterConfiguration', function() {
      // uncomment below and update the code to test ZoneClusterConfiguration
      //var instane = new Onepanel.ZoneClusterConfiguration();
      //expect(instance).to.be.a(Onepanel.ZoneClusterConfiguration);
    });
