...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Onepanel.CephConfigurationMonitors();
  });
  ...
  describe('CephConfigurationMonitors', function() {
    it('should create an instance of CephConfigurationMonitors', function() {
      // uncomment below and update the code to test CephConfigurationMonitors
      //var instane = new Onepanel.CephConfigurationMonitors();
      //expect(instance).to.be.a(Onepanel.CephConfigurationMonitors);
    });
