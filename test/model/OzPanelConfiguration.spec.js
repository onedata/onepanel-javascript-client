...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Onepanel.OzPanelConfiguration();
  });
  ...
  describe('OzPanelConfiguration', function() {
    it('should create an instance of OzPanelConfiguration', function() {
      // uncomment below and update the code to test OzPanelConfiguration
      //var instane = new Onepanel.OzPanelConfiguration();
      //expect(instance).to.be.a(Onepanel.OzPanelConfiguration);
    });
