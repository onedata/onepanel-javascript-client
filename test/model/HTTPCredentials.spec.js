...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Onepanel.HTTPCredentials();
  });
  ...
  describe('HTTPCredentials', function() {
    it('should create an instance of HTTPCredentials', function() {
      // uncomment below and update the code to test HTTPCredentials
      //var instane = new Onepanel.HTTPCredentials();
      //expect(instance).to.be.a(Onepanel.HTTPCredentials);
    });
