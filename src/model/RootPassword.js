...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.Onepanel.RootPassword = factory(root.Onepanel.ApiClient);
  }
   ...
   * @alias module:model/RootPassword
   * @class
   */
   ...
   *
   * @return {module:model/RootPassword} The value of 'discriminator' field or undefined.
   */
   ...
   * @param {module:model/RootPassword} obj Optional instance to populate.
   * @return {module:model/RootPassword} The populated <code>RootPassword</code> instance.
   */
