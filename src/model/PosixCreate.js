...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/PosixCommon', 'model/StorageCommonPathTypeCanonical', 'model/StorageCreateDetails'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./PosixCommon'), require('./StorageCommonPathTypeCanonical'), require('./StorageCreateDetails'));
  } else {
    // Browser globals (root is window)
    if (!root.Onepanel) {
      root.Onepanel = {};
    }
    root.Onepanel.PosixCreate = factory(root.Onepanel.ApiClient, root.Onepanel.PosixCommon, root.Onepanel.StorageCommonPathTypeCanonical, root.Onepanel.StorageCreateDetails);
  }
}(this, function(ApiClient, PosixCommon, StorageCommonPathTypeCanonical, StorageCreateDetails) {
  'use strict';
  ...
  /**
   * The PosixCreate model module.
   * @module model/PosixCreate
   * @version 20.02.1
   */

  /**
   * Constructs a new <code>PosixCreate</code>.
   ...
   *
   * @return {module:model/PosixCreate} The value of 'discriminator' field or undefined.
   */
  ...
  /**
   * Constructs a <code>PosixCreate</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/PosixCreate} obj Optional instance to populate.
   * @return {module:model/PosixCreate} The populated <code>PosixCreate</code> instance.
   */
