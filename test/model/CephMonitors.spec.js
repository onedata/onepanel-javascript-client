...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Onepanel.CephMonitors();
  });
  ...
  describe('CephMonitors', function() {
    it('should create an instance of CephMonitors', function() {
      // uncomment below and update the code to test CephMonitors
