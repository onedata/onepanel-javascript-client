...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.Onepanel.CephPoolStorageParams = factory(root.Onepanel.ApiClient);
  }
  ...
  /**
   * The CephPoolStorageParams model module.
   * @module model/CephPoolStorageParams
   * @version 18.02.0-rc12
   */

  /**
   * Constructs a new <code>CephPoolStorageParams</code>.
   * Parameters of Oneprovider storage backed by this pool.
   * @alias module:model/CephPoolStorageParams
   * @class
   */
   ...
   *
   * @return {module:model/CephPoolStorageParams} The value of 'discriminator' field or undefined.
   */
  ...
  /**
   * Constructs a <code>CephPoolStorageParams</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/CephPoolStorageParams} obj Optional instance to populate.
   * @return {module:model/CephPoolStorageParams} The populated <code>CephPoolStorageParams</code> instance.
   */
  ...
  /**
   * The name of storage. By default constructed as \"clustername:poolname\".
   * @member {String} name
   */
  ...
  /**
   * The monitor host name. If missing one of Ceph monitors is chosen arbitrarily.
