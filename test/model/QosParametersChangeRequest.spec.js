...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Onepanel.QosParametersChangeRequest();
  });
  ...
  describe('QosParametersChangeRequest', function() {
    it('should create an instance of QosParametersChangeRequest', function() {
      // uncomment below and update the code to test QosParametersChangeRequest
      //var instane = new Onepanel.QosParametersChangeRequest();
      //expect(instance).to.be.a(Onepanel.QosParametersChangeRequest);
    });
