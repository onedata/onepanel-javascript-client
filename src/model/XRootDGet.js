...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/StorageGetDetails', 'model/XRootDCredentials'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./StorageGetDetails'), require('./XRootDCredentials'));
  } else {
    // Browser globals (root is window)
    if (!root.Onepanel) {
      root.Onepanel = {};
    }
    root.Onepanel.XRootDGet = factory(root.Onepanel.ApiClient, root.Onepanel.StorageGetDetails, root.Onepanel.XRootDCredentials);
  }
}(this, function(ApiClient, StorageGetDetails, XRootDCredentials) {
  'use strict';
  ...
  /**
   * The XRootDGet model module.
   * @module model/XRootDGet
   * @version 25.1
   */

  /**
   * Constructs a new <code>XRootDGet</code>.
   * The XRootD storage configuration.
   * @alias module:model/XRootDGet
   * @class
   * @extends module:model/StorageGetDetails
   * @implements module:model/XRootDCredentials
   * @param type {module:model/XRootDGet.TypeEnum} The type of storage.  `type = \"xrootd\"`  Storage backend compatible with [XRootD](http://www.xrootd.org/) protocol. 
   ...
   *
   * @return {module:model/XRootDGet} The value of 'discriminator' field or undefined.
   */
  ...
  /**
   * Constructs a <code>XRootDGet</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/XRootDGet} obj Optional instance to populate.
   * @return {module:model/XRootDGet} The populated <code>XRootDGet</code> instance.
   */
   ...
   * @member {module:model/XRootDGet.TypeEnum} type
   */
   ...
   * @member {module:model/XRootDGet.StoragePathTypeEnum} storagePathType
   */
