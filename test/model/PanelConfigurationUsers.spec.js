...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Onepanel.PanelConfigurationUsers();
  });
  ...
  describe('PanelConfigurationUsers', function() {
    it('should create an instance of PanelConfigurationUsers', function() {
      // uncomment below and update the code to test PanelConfigurationUsers
      //var instane = new Onepanel.PanelConfigurationUsers();
      //expect(instance).to.be.a(Onepanel.PanelConfigurationUsers);
    });
