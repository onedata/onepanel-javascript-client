...
(function(root, factory) {
   ...
   * @param type {module:model/CephradosCredentials.TypeEnum} Type of the storage. Must match the type of existing storage, needed only for OpenAPI polymorphism disambiguation. 
