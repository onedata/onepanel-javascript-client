...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.Onepanel.WebdavCommon = factory(root.Onepanel.ApiClient);
  }
  ...
  /**
   * The WebdavCommon model module.
   * @module model/WebdavCommon
   * @version 20.02.1
   */

  /**
   * Constructs a new <code>WebdavCommon</code>.
   * The WebDAV storage configuration.
   * @alias module:model/WebdavCommon
   * @class
   */
   ...
   *
   * @return {module:model/WebdavCommon} The value of 'discriminator' field or undefined.
   */
  ...
  /**
   * Constructs a <code>WebdavCommon</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/WebdavCommon} obj Optional instance to populate.
   * @return {module:model/WebdavCommon} The populated <code>WebdavCommon</code> instance.
   */
