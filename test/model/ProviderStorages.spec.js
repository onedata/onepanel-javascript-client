...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Onepanel.ProviderStorages();
  });
  ...
  describe('ProviderStorages', function() {
    it('should create an instance of ProviderStorages', function() {
      // uncomment below and update the code to test ProviderStorages
      //var instane = new Onepanel.ProviderStorages();
      //expect(instance).to.be.a(Onepanel.ProviderStorages);
    });
