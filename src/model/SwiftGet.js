...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/StorageGetDetails', 'model/SwiftCredentials'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./StorageGetDetails'), require('./SwiftCredentials'));
  } else {
    // Browser globals (root is window)
    if (!root.Onepanel) {
      root.Onepanel = {};
    }
    root.Onepanel.SwiftGet = factory(root.Onepanel.ApiClient, root.Onepanel.StorageGetDetails, root.Onepanel.SwiftCredentials);
  }
}(this, function(ApiClient, StorageGetDetails, SwiftCredentials) {
  'use strict';
  ...
  /**
   * The SwiftGet model module.
   * @module model/SwiftGet
   * @version 21.02.8
   */

  /**
   * Constructs a new <code>SwiftGet</code>.
   * The OpenStack Swift configuration.
   * @alias module:model/SwiftGet
   * @class
   * @extends module:model/StorageGetDetails
   * @implements module:model/SwiftCredentials
   * @param type {module:model/SwiftGet.TypeEnum} The type of storage.  `type = \"swift\"`  Storage backend compatible with [OpenStack](http://docs.openstack.org/developer/swift/) SWIFT protocol. 
   ...
   *
   * @return {module:model/SwiftGet} The value of 'discriminator' field or undefined.
   */
  ...
  /**
   * Constructs a <code>SwiftGet</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/SwiftGet} obj Optional instance to populate.
   * @return {module:model/SwiftGet} The populated <code>SwiftGet</code> instance.
   */
   ...
   * @member {module:model/SwiftGet.TypeEnum} type
   */
