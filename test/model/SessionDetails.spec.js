...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Onepanel.SessionDetails();
  });
  ...
  describe('SessionDetails', function() {
    it('should create an instance of SessionDetails', function() {
      // uncomment below and update the code to test SessionDetails
      //var instane = new Onepanel.SessionDetails();
      //expect(instance).to.be.a(Onepanel.SessionDetails);
    });
