...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/CephPool', 'model/StorageCreateDetails'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./CephPool'), require('./StorageCreateDetails'));
  } else {
    // Browser globals (root is window)
    if (!root.Onepanel) {
      root.Onepanel = {};
    }
    root.Onepanel.LocalcephCreate = factory(root.Onepanel.ApiClient, root.Onepanel.CephPool, root.Onepanel.StorageCreateDetails);
  }
}(this, function(ApiClient, CephPool, StorageCreateDetails) {
  'use strict';
