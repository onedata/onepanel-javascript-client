...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/CephradosCredentials', 'model/StorageCreateDetails'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./CephradosCredentials'), require('./StorageCreateDetails'));
  } else {
    // Browser globals (root is window)
    if (!root.Onepanel) {
      root.Onepanel = {};
    }
    root.Onepanel.CephradosCreate = factory(root.Onepanel.ApiClient, root.Onepanel.CephradosCredentials, root.Onepanel.StorageCreateDetails);
  }
}(this, function(ApiClient, CephradosCredentials, StorageCreateDetails) {
  'use strict';
   ...
   * @param type {module:model/CephradosCreate.TypeEnum} The type of storage.  `type = \"cephrados\"`  Storage backend compatible with [Ceph](http://ceph.com/ceph-storage/) object storage. 
