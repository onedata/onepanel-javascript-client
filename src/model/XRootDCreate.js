...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/StorageCommonPathTypeCanonical', 'model/StorageCreateDetails', 'model/XRootDCommon', 'model/XRootDCredentials'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./StorageCommonPathTypeCanonical'), require('./StorageCreateDetails'), require('./XRootDCommon'), require('./XRootDCredentials'));
  } else {
    // Browser globals (root is window)
    if (!root.Onepanel) {
      root.Onepanel = {};
    }
    root.Onepanel.XRootDCreate = factory(root.Onepanel.ApiClient, root.Onepanel.StorageCommonPathTypeCanonical, root.Onepanel.StorageCreateDetails, root.Onepanel.XRootDCommon, root.Onepanel.XRootDCredentials);
  }
}(this, function(ApiClient, StorageCommonPathTypeCanonical, StorageCreateDetails, XRootDCommon, XRootDCredentials) {
  'use strict';
  ...
  /**
   * The XRootDCreate model module.
   * @module model/XRootDCreate
   * @version 20.02.1
   */

  /**
   * Constructs a new <code>XRootDCreate</code>.
   * The XRootD storage configuration.
   * @alias module:model/XRootDCreate
   * @class
   ...
   *
   * @return {module:model/XRootDCreate} The value of 'discriminator' field or undefined.
   */
  ...
  /**
   * Constructs a <code>XRootDCreate</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/XRootDCreate} obj Optional instance to populate.
   * @return {module:model/XRootDCreate} The populated <code>XRootDCreate</code> instance.
   */
