...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/CephradosCredentials', 'model/StorageGetDetails'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./CephradosCredentials'), require('./StorageGetDetails'));
  } else {
    // Browser globals (root is window)
    if (!root.Onepanel) {
      root.Onepanel = {};
    }
    root.Onepanel.CephradosGet = factory(root.Onepanel.ApiClient, root.Onepanel.CephradosCredentials, root.Onepanel.StorageGetDetails);
  }
}(this, function(ApiClient, CephradosCredentials, StorageGetDetails) {
  'use strict';
  ...
  /**
   * The CephradosGet model module.
   * @module model/CephradosGet
   * @version 21.02.8
   */
   ...
   * @param type {module:model/CephradosGet.TypeEnum} The type of storage.  `type = \"cephrados\"`  Storage backend compatible with [Ceph](http://ceph.com/ceph-storage/) object storage. 
   ...
   *
   * @return {module:model/CephradosGet} The value of 'discriminator' field or undefined.
   */
  ...
  /**
   * Constructs a <code>CephradosGet</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/CephradosGet} obj Optional instance to populate.
   * @return {module:model/CephradosGet} The populated <code>CephradosGet</code> instance.
   */
   ...
   * @member {module:model/CephradosGet.TypeEnum} type
   */
   ...
   * @member {module:model/CephradosGet.StoragePathTypeEnum} storagePathType
   */
