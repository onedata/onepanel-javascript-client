...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.Onepanel.CephPoolModifyRequest = factory(root.Onepanel.ApiClient);
  }
  ...
  /**
   * The CephPoolModifyRequest model module.
   * @module model/CephPoolModifyRequest
   * @version 18.02.0-rc12
   */

  /**
   * Constructs a new <code>CephPoolModifyRequest</code>.
   * Describes params of a Ceph pool to be changed.
   * @alias module:model/CephPoolModifyRequest
   * @class
   */
   ...
   *
   * @return {module:model/CephPoolModifyRequest} The value of 'discriminator' field or undefined.
   */
  ...
  /**
   * Constructs a <code>CephPoolModifyRequest</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/CephPoolModifyRequest} obj Optional instance to populate.
   * @return {module:model/CephPoolModifyRequest} The populated <code>CephPoolModifyRequest</code> instance.
   */
