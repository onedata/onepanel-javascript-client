...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.Onepanel.ClusterMembership = factory(root.Onepanel.ApiClient);
  }
  ...
  /**
   * The ClusterMembership model module.
   * @module model/ClusterMembership
   * @version 18.02.1
   */

  /**
   * Constructs a new <code>ClusterMembership</code>.
   * Summary of cluster membership, listing number of direct and effective users and groups.
   * @alias module:model/ClusterMembership
   * @class
   */
   ...
   *
   * @return {module:model/ClusterMembership} The value of 'discriminator' field or undefined.
   */
  ...
  /**
   * Constructs a <code>ClusterMembership</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/ClusterMembership} obj Optional instance to populate.
   * @return {module:model/ClusterMembership} The populated <code>ClusterMembership</code> instance.
   */
