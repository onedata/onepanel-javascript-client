...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/GlusterfsCredentials', 'model/StorageGetDetails'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./GlusterfsCredentials'), require('./StorageGetDetails'));
  } else {
    // Browser globals (root is window)
    if (!root.Onepanel) {
      root.Onepanel = {};
    }
    root.Onepanel.GlusterfsGet = factory(root.Onepanel.ApiClient, root.Onepanel.GlusterfsCredentials, root.Onepanel.StorageGetDetails);
  }
}(this, function(ApiClient, GlusterfsCredentials, StorageGetDetails) {
  'use strict';
  ...
  /**
   * The GlusterfsGet model module.
   * @module model/GlusterfsGet
   * @version 21.02.8
   */

  /**
   * Constructs a new <code>GlusterfsGet</code>.
   * The GlusterFS storage configuration.
   * @alias module:model/GlusterfsGet
   * @class
   ...
   *
   * @return {module:model/GlusterfsGet} The value of 'discriminator' field or undefined.
   */
  ...
  /**
   * Constructs a <code>GlusterfsGet</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/GlusterfsGet} obj Optional instance to populate.
   * @return {module:model/GlusterfsGet} The populated <code>GlusterfsGet</code> instance.
   */
   ...
   * @member {module:model/GlusterfsGet.TypeEnum} type
   */
   ...
   * @member {module:model/GlusterfsGet.TransportEnum} transport
   */
   ...
   * @member {module:model/GlusterfsGet.StoragePathTypeEnum} storagePathType
   */
