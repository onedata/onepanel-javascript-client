...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Onepanel.RootPasswordStatus();
  });
  ...
  describe('RootPasswordStatus', function() {
    it('should create an instance of RootPasswordStatus', function() {
      // uncomment below and update the code to test RootPasswordStatus
      //var instane = new Onepanel.RootPasswordStatus();
      //expect(instance).to.be.a(Onepanel.RootPasswordStatus);
    });
