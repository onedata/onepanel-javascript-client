...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Onepanel.ClusterWorkers();
  });
  ...
  describe('ClusterWorkers', function() {
    it('should create an instance of ClusterWorkers', function() {
      // uncomment below and update the code to test ClusterWorkers
      //var instane = new Onepanel.ClusterWorkers();
      //expect(instance).to.be.a(Onepanel.ClusterWorkers);
    });
