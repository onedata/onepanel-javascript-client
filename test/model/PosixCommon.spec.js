...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Onepanel.PosixCommon();
  });
  ...
  describe('PosixCommon', function() {
    it('should create an instance of PosixCommon', function() {
      // uncomment below and update the code to test PosixCommon
      //var instane = new Onepanel.PosixCommon();
      //expect(instance).to.be.a(Onepanel.PosixCommon);
    });
