...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.Onepanel.CephConfigurationCluster = factory(root.Onepanel.ApiClient);
  }
  ...
  /**
   * The CephConfigurationCluster model module.
   * @module model/CephConfigurationCluster
   * @version 18.02.0-rc12
   */

  /**
   * Constructs a new <code>CephConfigurationCluster</code>.
   * Global Ceph cluster properties.
   * @alias module:model/CephConfigurationCluster
   * @class
   */
   ...
   *
   * @return {module:model/CephConfigurationCluster} The value of 'discriminator' field or undefined.
   */
  ...
  /**
   * Constructs a <code>CephConfigurationCluster</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/CephConfigurationCluster} obj Optional instance to populate.
   * @return {module:model/CephConfigurationCluster} The populated <code>CephConfigurationCluster</code> instance.
   */
