...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.Onepanel.CephradosCredentialsOptional = factory(root.Onepanel.ApiClient, root.Onepanel.LumaStorageCredentials);
  }
  ...
  /**
   * The CephradosCredentialsOptional model module.
   * @module model/CephradosCredentialsOptional
   * @version 20.02.1
   */

  /**
   * Constructs a new <code>CephradosCredentialsOptional</code>.
   * Credentials on the Ceph storage (using librados).
   * @alias module:model/CephradosCredentialsOptional
   * @class
   ...
   *
   * @return {module:model/CephradosCredentialsOptional} The value of 'discriminator' field or undefined.
   */
  ...
  /**
   * Constructs a <code>CephradosCredentialsOptional</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/CephradosCredentialsOptional} obj Optional instance to populate.
   * @return {module:model/CephradosCredentialsOptional} The populated <code>CephradosCredentialsOptional</code> instance.
   */
