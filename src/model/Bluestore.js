...
(function(root, factory) {
   ...
   * Bluestore OSD specification. Bluestore means OSD is backed by a whole block device formatted to its needs.
  ...
  /**
   * Specifies block device to be ERASED and FORMATTED to be used for this OSD's database. It should be used when a storage faster than \"device\" is available, otherwise it is sufficient to specify just the \"device\". 
   * @member {String} dbDevice
   */
  exports.prototype['dbDevice'] = undefined;
  /**
   * Specifies block device to be ERASED and FORMATTED for use as the Write Ahead Log. It should be used when a storage faster than \"device\" is available, otherwise it is sufficient to specify just the \"device\". 
