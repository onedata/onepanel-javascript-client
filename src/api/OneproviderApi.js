...
(function(root, factory) {
  ...
  var exports = function(apiClient) {
     ...
     * @param {module:model/SpaceFilePopularity} enabled Value informing whether collecting file-popularity statistics in the space should be turned on or off.
