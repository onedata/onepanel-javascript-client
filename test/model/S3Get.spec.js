...
(function(root, factory) {
  ...
  describe('S3Get', function() {
    it('should create an instance of S3Get', function() {
      // uncomment below and update the code to test S3Get
      //var instane = new Onepanel.S3Get();
      //expect(instance).to.be.a(Onepanel.S3Get);
    });
