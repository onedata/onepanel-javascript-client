...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.Onepanel.ClusterMembersSummary = factory(root.Onepanel.ApiClient);
  }
  ...
  /**
   * The ClusterMembersSummary model module.
   * @module model/ClusterMembersSummary
   * @version 18.02.1
   */

  /**
   * Constructs a new <code>ClusterMembersSummary</code>.
   * Summary of cluster members, listing number of direct and effective users and groups.
   * @alias module:model/ClusterMembersSummary
   * @class
   */
   ...
   *
   * @return {module:model/ClusterMembersSummary} The value of 'discriminator' field or undefined.
   */
  ...
  /**
   * Constructs a <code>ClusterMembersSummary</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/ClusterMembersSummary} obj Optional instance to populate.
   * @return {module:model/ClusterMembersSummary} The populated <code>ClusterMembersSummary</code> instance.
   */
