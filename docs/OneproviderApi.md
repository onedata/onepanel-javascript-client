...
[**cancelStorageImportScan**](OneproviderApi.md#cancelStorageImportScan) | **POST** /provider/spaces/{id}/sync/cancel | Cancels storage import scan
...
<a name="cancelStorageImportScan"></a>
# **cancelStorageImportScan**
> cancelStorageImportScan(id)
...
apiInstance.cancelStorageImportScan(id, callback);
```
