...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/CephCredentials', 'model/StorageGetDetails'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./CephCredentials'), require('./StorageGetDetails'));
  } else {
    // Browser globals (root is window)
    if (!root.Onepanel) {
      root.Onepanel = {};
    }
    root.Onepanel.CephGet = factory(root.Onepanel.ApiClient, root.Onepanel.CephCredentials, root.Onepanel.StorageGetDetails);
  }
}(this, function(ApiClient, CephCredentials, StorageGetDetails) {
  'use strict';
  ...
  /**
   * The CephGet model module.
   * @module model/CephGet
   * @version 25.1
   */

  /**
   * Constructs a new <code>CephGet</code>.
   * The Ceph storage configuration (uses libradosstriper).
   * @alias module:model/CephGet
   * @class
   * @extends module:model/StorageGetDetails
   * @implements module:model/CephCredentials
   * @param type {module:model/CephGet.TypeEnum} The type of storage.  `type = \"ceph\"`  (**DEPRECATED** - use Ceph RADOS instead) storage backend compatible with [Ceph](http://ceph.com/ceph-storage/) object storage, using the deprecated `libradosstriper` library. 
   ...
   *
   * @return {module:model/CephGet} The value of 'discriminator' field or undefined.
   */
  ...
  /**
   * Constructs a <code>CephGet</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/CephGet} obj Optional instance to populate.
   * @return {module:model/CephGet} The populated <code>CephGet</code> instance.
   */
   ...
   * @member {module:model/CephGet.TypeEnum} type
   */
   ...
   * @member {module:model/CephGet.StoragePathTypeEnum} storagePathType
   */
