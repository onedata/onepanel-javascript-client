...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.Onepanel.ServiceHosts = factory(root.Onepanel.ApiClient);
  }
  ...
  /**
   * The ServiceHosts model module.
   * @module model/ServiceHosts
   * @version 18.02.1
   */

  /**
   * Constructs a new <code>ServiceHosts</code>.
   * The service hosts configuration.
   * @alias module:model/ServiceHosts
   * @class
   ...
   *
   * @return {module:model/ServiceHosts} The value of 'discriminator' field or undefined.
   */
  ...
  /**
   * Constructs a <code>ServiceHosts</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/ServiceHosts} obj Optional instance to populate.
   * @return {module:model/ServiceHosts} The populated <code>ServiceHosts</code> instance.
   */
