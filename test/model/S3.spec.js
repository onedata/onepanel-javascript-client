...
(function(root, factory) {
  ...
  describe('S3', function() {
    ...
    it('should have the property s3Hostname (base name: "s3Hostname")', function() {
      // uncomment below and update the code to test the property s3Hostname
      //var instane = new Onepanel.S3();
      //expect(instance).to.be();
    });

    it('should have the property iamHostname (base name: "iamHostname")', function() {
      // uncomment below and update the code to test the property iamHostname
      //var instane = new Onepanel.S3();
      //expect(instance).to.be();
    });
