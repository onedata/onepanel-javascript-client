...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Onepanel.HTTPCommon();
  });
  ...
  describe('HTTPCommon', function() {
    it('should create an instance of HTTPCommon', function() {
      // uncomment below and update the code to test HTTPCommon
      //var instane = new Onepanel.HTTPCommon();
      //expect(instance).to.be.a(Onepanel.HTTPCommon);
    });
