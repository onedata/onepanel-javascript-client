...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Onepanel.WebdavCommon();
  });
  ...
  describe('WebdavCommon', function() {
    it('should create an instance of WebdavCommon', function() {
      // uncomment below and update the code to test WebdavCommon
      //var instane = new Onepanel.WebdavCommon();
      //expect(instance).to.be.a(Onepanel.WebdavCommon);
    });
