...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.Onepanel.DatabaseHosts = factory(root.Onepanel.ApiClient);
  }
  ...
  /**
   * The DatabaseHosts model module.
   * @module model/DatabaseHosts
   * @version 19.02.0-beta1
   */

  /**
   * Constructs a new <code>DatabaseHosts</code>.
   * The cluster database service hosts configuration.
   * @alias module:model/DatabaseHosts
   * @class
   ...
   *
   * @return {module:model/DatabaseHosts} The value of 'discriminator' field or undefined.
   */
  ...
  /**
   * Constructs a <code>DatabaseHosts</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/DatabaseHosts} obj Optional instance to populate.
   * @return {module:model/DatabaseHosts} The populated <code>DatabaseHosts</code> instance.
   */
