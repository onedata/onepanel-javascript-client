...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/CephOsdConfiguration'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./CephOsdConfiguration'));
  } else {
    // Browser globals (root is window)
    if (!root.Onepanel) {
      root.Onepanel = {};
    }
    root.Onepanel.CephOsdsConfiguration = factory(root.Onepanel.ApiClient, root.Onepanel.CephOsdConfiguration);
  }
}(this, function(ApiClient, CephOsdConfiguration) {
  'use strict';
  ...
  /**
   * The CephOsdsConfiguration model module.
   * @module model/CephOsdsConfiguration
   * @version 18.02.0-rc12
   */

  /**
   * Constructs a new <code>CephOsdsConfiguration</code>.
   * 
   * @alias module:model/CephOsdsConfiguration
   * @class
   * @param osds {Array.<module:model/CephOsdConfiguration>} @fixme
   */
  var exports = function(osds) {
    var _this = this;
   ...
   *
   * @return {module:model/CephOsdsConfiguration} The value of 'discriminator' field or undefined.
   */
  ...
  /**
   * Constructs a <code>CephOsdsConfiguration</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/CephOsdsConfiguration} obj Optional instance to populate.
   * @return {module:model/CephOsdsConfiguration} The populated <code>CephOsdsConfiguration</code> instance.
   */
