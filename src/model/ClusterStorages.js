...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.Onepanel.ClusterStorages = factory(root.Onepanel.ApiClient);
  }
  ...
  /**
   * The ClusterStorages model module.
   * @module model/ClusterStorages
   * @version 3.0.0-rc11
   */

  /**
   * Constructs a new <code>ClusterStorages</code>.
   * The cluster storage configuration.
   * @alias module:model/ClusterStorages
   * @class
   ...
   *
   * @return {module:model/ClusterStorages} The value of 'discriminator' field or undefined.
   */
  ...
  /**
   * Constructs a <code>ClusterStorages</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/ClusterStorages} obj Optional instance to populate.
   * @return {module:model/ClusterStorages} The populated <code>ClusterStorages</code> instance.
   */
  ...
  /**
   * The type of storage.
   * @member {module:model/ClusterStorages.TypeEnum} type
   */
