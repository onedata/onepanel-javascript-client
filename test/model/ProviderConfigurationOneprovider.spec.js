...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Onepanel.ProviderConfigurationOneprovider();
  });
  ...
  describe('ProviderConfigurationOneprovider', function() {
    it('should create an instance of ProviderConfigurationOneprovider', function() {
      // uncomment below and update the code to test ProviderConfigurationOneprovider
