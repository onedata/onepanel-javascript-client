...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.Onepanel.CephMgrConfiguration = factory(root.Onepanel.ApiClient);
  }
  ...
  /**
   * The CephMgrConfiguration model module.
   * @module model/CephMgrConfiguration
   * @version 18.02.0-rc12
   */

  /**
   * Constructs a new <code>CephMgrConfiguration</code>.
   * @fixme
   * @alias module:model/CephMgrConfiguration
   * @class
   */
   ...
   *
   * @return {module:model/CephMgrConfiguration} The value of 'discriminator' field or undefined.
   */
  ...
  /**
   * Constructs a <code>CephMgrConfiguration</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/CephMgrConfiguration} obj Optional instance to populate.
   * @return {module:model/CephMgrConfiguration} The populated <code>CephMgrConfiguration</code> instance.
   */
