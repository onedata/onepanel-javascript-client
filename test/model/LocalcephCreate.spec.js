...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Onepanel.LocalcephCreate();
  });
  ...
  describe('LocalcephCreate', function() {
    it('should create an instance of LocalcephCreate', function() {
      // uncomment below and update the code to test LocalcephCreate
      //var instane = new Onepanel.LocalcephCreate();
      //expect(instance).to.be.a(Onepanel.LocalcephCreate);
    });
