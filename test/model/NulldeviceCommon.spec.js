...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Onepanel.NulldeviceCommon();
  });
  ...
  describe('NulldeviceCommon', function() {
    it('should create an instance of NulldeviceCommon', function() {
      // uncomment below and update the code to test NulldeviceCommon
      //var instane = new Onepanel.NulldeviceCommon();
      //expect(instance).to.be.a(Onepanel.NulldeviceCommon);
    });
