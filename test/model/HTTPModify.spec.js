...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Onepanel.HTTPModify();
  });
  ...
  describe('HTTPModify', function() {
    it('should create an instance of HTTPModify', function() {
      // uncomment below and update the code to test HTTPModify
      //var instane = new Onepanel.HTTPModify();
      //expect(instance).to.be.a(Onepanel.HTTPModify);
    });
