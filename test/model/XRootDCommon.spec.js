...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Onepanel.XRootDCommon();
  });
  ...
  describe('XRootDCommon', function() {
    it('should create an instance of XRootDCommon', function() {
      // uncomment below and update the code to test XRootDCommon
      //var instane = new Onepanel.XRootDCommon();
      //expect(instance).to.be.a(Onepanel.XRootDCommon);
    });
