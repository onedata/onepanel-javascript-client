...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Onepanel.CephOsdConfiguration();
  });
  ...
  describe('CephOsdConfiguration', function() {
    it('should create an instance of CephOsdConfiguration', function() {
      // uncomment below and update the code to test CephOsdConfiguration
      //var instane = new Onepanel.CephOsdConfiguration();
      //expect(instance).to.be.a(Onepanel.CephOsdConfiguration);
    });
