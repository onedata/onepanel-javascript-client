...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Onepanel.SwiftGet();
  });
  ...
  describe('SwiftGet', function() {
    it('should create an instance of SwiftGet', function() {
      // uncomment below and update the code to test SwiftGet
      //var instane = new Onepanel.SwiftGet();
      //expect(instance).to.be.a(Onepanel.SwiftGet);
    });
