...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.Onepanel.CephCommon = factory(root.Onepanel.ApiClient);
  }
  ...
  /**
   * The CephCommon model module.
   * @module model/CephCommon
   * @version 20.02.1
   */

  /**
   * Constructs a new <code>CephCommon</code>.
   * The Ceph storage configuration (uses libradosstriper).
   * @alias module:model/CephCommon
   * @class
   ...
   *
   * @return {module:model/CephCommon} The value of 'discriminator' field or undefined.
   */
  ...
  /**
   * Constructs a <code>CephCommon</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/CephCommon} obj Optional instance to populate.
   * @return {module:model/CephCommon} The populated <code>CephCommon</code> instance.
   */
