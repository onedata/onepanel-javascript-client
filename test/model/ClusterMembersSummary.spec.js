...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Onepanel.ClusterMembersSummary();
  });
  ...
  describe('ClusterMembersSummary', function() {
    it('should create an instance of ClusterMembersSummary', function() {
      // uncomment below and update the code to test ClusterMembersSummary
      //var instane = new Onepanel.ClusterMembersSummary();
      //expect(instance).to.be.a(Onepanel.ClusterMembersSummary);
    });
