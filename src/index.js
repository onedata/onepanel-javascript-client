...
(function(factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/Ceph', 'model/ClusterDatabases', 'model/ClusterManagers', 'model/ClusterStorages', 'model/ClusterStoragesList', 'model/ClusterWorkers', 'model/Cookie', 'model/Error', 'model/ManagerHosts', 'model/POSIX', 'model/PanelConfiguration', 'model/PanelConfigurationUsers', 'model/ProviderClusterConfiguration', 'model/ProviderConfiguration', 'model/ProviderConfigurationOneprovider', 'model/ProviderConfigurationOnezone', 'model/ProviderDetails', 'model/ProviderModifyRequest', 'model/ProviderRegisterRequest', 'model/ProviderSpaces', 'model/S3', 'model/ServiceDatabases', 'model/ServiceError', 'model/ServiceHosts', 'model/ServiceStatus', 'model/ServiceStatusHost', 'model/SpaceDetails', 'model/SpaceSupportRequest', 'model/Swift', 'model/TaskStatus', 'model/UserCreateRequest', 'model/UserDetails', 'model/UserModifyRequest', 'model/ZoneClusterConfiguration', 'model/ZoneClusterConfigurationNodes', 'model/ZoneConfiguration', 'model/ZoneConfigurationOnezone', 'api/OnepanelApi', 'api/OneproviderApi', 'api/OnezoneApi'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('./ApiClient'), require('./model/Ceph'), require('./model/ClusterDatabases'), require('./model/ClusterManagers'), require('./model/ClusterStorages'), require('./model/ClusterStoragesList'), require('./model/ClusterWorkers'), require('./model/Cookie'), require('./model/Error'), require('./model/ManagerHosts'), require('./model/POSIX'), require('./model/PanelConfiguration'), require('./model/PanelConfigurationUsers'), require('./model/ProviderClusterConfiguration'), require('./model/ProviderConfiguration'), require('./model/ProviderConfigurationOneprovider'), require('./model/ProviderConfigurationOnezone'), require('./model/ProviderDetails'), require('./model/ProviderModifyRequest'), require('./model/ProviderRegisterRequest'), require('./model/ProviderSpaces'), require('./model/S3'), require('./model/ServiceDatabases'), require('./model/ServiceError'), require('./model/ServiceHosts'), require('./model/ServiceStatus'), require('./model/ServiceStatusHost'), require('./model/SpaceDetails'), require('./model/SpaceSupportRequest'), require('./model/Swift'), require('./model/TaskStatus'), require('./model/UserCreateRequest'), require('./model/UserDetails'), require('./model/UserModifyRequest'), require('./model/ZoneClusterConfiguration'), require('./model/ZoneClusterConfigurationNodes'), require('./model/ZoneConfiguration'), require('./model/ZoneConfigurationOnezone'), require('./api/OnepanelApi'), require('./api/OneproviderApi'), require('./api/OnezoneApi'));
  }
}(function(ApiClient, Ceph, ClusterDatabases, ClusterManagers, ClusterStorages, ClusterStoragesList, ClusterWorkers, Cookie, Error, ManagerHosts, POSIX, PanelConfiguration, PanelConfigurationUsers, ProviderClusterConfiguration, ProviderConfiguration, ProviderConfigurationOneprovider, ProviderConfigurationOnezone, ProviderDetails, ProviderModifyRequest, ProviderRegisterRequest, ProviderSpaces, S3, ServiceDatabases, ServiceError, ServiceHosts, ServiceStatus, ServiceStatusHost, SpaceDetails, SpaceSupportRequest, Swift, TaskStatus, UserCreateRequest, UserDetails, UserModifyRequest, ZoneClusterConfiguration, ZoneClusterConfigurationNodes, ZoneConfiguration, ZoneConfigurationOnezone, OnepanelApi, OneproviderApi, OnezoneApi) {
  'use strict';

  /**
   * _OverviewThis_is_the_RESTful_API_definition_of_Onepanel_component_of_Onedata_data_management_system__onedata_org_httpwww_onedata_org__This_API_is_defined_using__Swagger_httpswagger_io_the_JSON_specification_can_be_used_to_automatically_generate_client_libraries____swagger_json_______swaggeronepanelswagger_json_This_API_allows_control_and_configuration_of_local_Onedata_deployment_in_particular_full_control_over_the_Onezone_and_Oneprovider_services_and_their_distribution_and_monitoring_on_the_local_resources_Each_of_these_components_is_composed_of_the_following_services___Worker_services___these_are_available_under_zoneworkers_and_providerworkers_paths___Databases_services___each_Onedata_component_stores_its_metadata_in_a_Couchbase_backend_which_can_be_distributed_on_any_number_of_nodes_these_are_available_under_zonedatabases_and_providerdatabases_paths___Cluster_manager_services___this_is_a_service_which_controls_other_deployed_processes_in_one_site_these_are_availables_under_these_are_available_under_zonemanagers_and_providermanagers_paths_Onezone_and_Oneprovider_components_are_composed_of_3_types_of_services_managers_databases_and_workers_Using_this_API_each_of_these_components_can_be_deployed_configured_started_and_stopped_ona_specified_host_in_the_local_site_in_the_context_of_either_Onezone_or_Oneprovider_service_All_paths_listed_in_this_documentation_are_relative_to_the_base_Onepanel_REST_API_which_is_apiv3onepanelso_complete_URL_for_a_request_to_Onepanel_service_ishttpHOSTNAMEPORTapiv3onepanel____AuthenticationOnepanel_supports_only_HTTP_basic_authentication_i_e__using_username_and_password_which_were_set_when_creating_users_Onepanel_users_can_have_2_roles___admin___Onepanel_administrator_there_can_be_multiple_administrators_and_all_have_equal_rights_in_terms_of_Onedata_deployment_management___regular___this_role_allows_manual_creation_of_user_accounts_using_which_users_can_login_to_Onezone_service_using_HTTP_Basic_authentication_without_OpenID__This_role_makes_sense_only_on_Onepanel_which_manages_Onezone_deployment_The_first_user_account_which_is_created_in_Onepanel_is_always_an_admin_account__API_structureThe_Onepanel_API_is_structured_to_reflect_that_it_can_either_be_used_to_control_Onezoneor_Oneprovider_deployment_each_Onedata_component_deployment_has_a_separate_Onepanelinstance__In_order_to_make_the_API_calls_explicit_Onezone_or_Oneprovider_specificrequests_have_different_paths_i_e____Onezone_specific_operations_start_with_apiv3onepanelzone___Oneprovider_specific_operations_start_with_apiv3onepanelprovider___Common_operations_paths_include_apiv3onepanelusers_apiv3onepanelhosts_and_apiv3onepaneltasksThe_overall_configuration_of_each_component_can_be_controlled_by_updating_apiv3onepanelzoneconfiguration_andapiv3onepanelproviderconfiguration_resources__ExamplesBelow_are_some_example_requests_to_Onepanel_using_cURLCreate_new_userbashcurl__X_POST__k__vvv__H_content_type_applicationjson__d_username_admin_password_Password1_userRole_admin_https172_17_0_69443apiv3onepanelusersAdd_storage_resource_to_providerbashcurl__X_PUT__u_adminPassword1__k__vvv__H_content_type_applicationjson__d_NFS_type_posix_mountPoint_mntvfs_https172_17_0_49443apiv3onepanelproviderstoragesAdd_a_new_Onezone_workerbashcurl__X_PUT__u_adminPassword1__k__vvv__H_content_type_applicationjson__d_hosts__node1_p1_1_dev_https172_17_0_49443apiv3onepanelzoneworkers.<br>
