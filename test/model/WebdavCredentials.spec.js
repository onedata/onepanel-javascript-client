...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Onepanel.WebdavCredentials();
  });
  ...
  describe('WebdavCredentials', function() {
    it('should create an instance of WebdavCredentials', function() {
      // uncomment below and update the code to test WebdavCredentials
      //var instane = new Onepanel.WebdavCredentials();
      //expect(instance).to.be.a(Onepanel.WebdavCredentials);
    });
