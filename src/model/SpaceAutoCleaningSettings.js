...
(function(root, factory) {
   ...
   * Settings for auto cleaning algorithms - for what files and when it should be started 
  ...
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('spaceSoftQuota')) {
        obj['spaceSoftQuota'] = ApiClient.convertToType(data['spaceSoftQuota'], 'Number');
      }
      if (data.hasOwnProperty('spaceHardQuota')) {
        obj['spaceHardQuota'] = ApiClient.convertToType(data['spaceHardQuota'], 'Number');
      }
    }
    return obj;
  }
  ...
  /**
   * Only files which size [b] exceeds given should be cleaned
   * @member {Number} fileSizeGreaterThan
   */
  exports.prototype['fileSizeGreaterThan'] = undefined;
  /**
   * Only files which size [b] is lesser than given should be cleaned 
   * @member {Number} fileSizeLesserThan
   */
  exports.prototype['fileSizeLesserThan'] = undefined;
  /**
   * Only files that were not active for given amount of time [s] should be cleaned 
   * @member {Number} fileTimeNotActive
   */
  exports.prototype['fileTimeNotActive'] = undefined;
  /**
   * Start cleaning after delay if given soft quota is exceeded
   * @member {Number} spaceSoftQuota
   */
  exports.prototype['spaceSoftQuota'] = undefined;
  /**
   * Start cleaning after delay if given soft quota is exceeded
   * @member {Number} spaceHardQuota
   */
  exports.prototype['spaceHardQuota'] = undefined;
