...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Onepanel.ClusterStoragesList();
  });
  ...
  describe('ClusterStoragesList', function() {
    it('should create an instance of ClusterStoragesList', function() {
      // uncomment below and update the code to test ClusterStoragesList
      //var instane = new Onepanel.ClusterStoragesList();
      //expect(instance).to.be.a(Onepanel.ClusterStoragesList);
    });
