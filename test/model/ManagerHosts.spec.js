...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Onepanel.ManagerHosts();
  });
  ...
  describe('ManagerHosts', function() {
    it('should create an instance of ManagerHosts', function() {
      // uncomment below and update the code to test ManagerHosts
      //var instane = new Onepanel.ManagerHosts();
      //expect(instance).to.be.a(Onepanel.ManagerHosts);
    });

    it('should have the property mainHost (base name: "mainHost")', function() {
      // uncomment below and update the code to test the property mainHost
      //var instane = new Onepanel.ManagerHosts();
