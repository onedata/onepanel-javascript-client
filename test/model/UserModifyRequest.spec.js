...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Onepanel.UserModifyRequest();
  });
  ...
  describe('UserModifyRequest', function() {
    it('should create an instance of UserModifyRequest', function() {
      // uncomment below and update the code to test UserModifyRequest
