...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/NulldeviceCredentials', 'model/StorageGetDetails'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./NulldeviceCredentials'), require('./StorageGetDetails'));
  } else {
    // Browser globals (root is window)
    if (!root.Onepanel) {
      root.Onepanel = {};
    }
    root.Onepanel.NulldeviceGet = factory(root.Onepanel.ApiClient, root.Onepanel.NulldeviceCredentials, root.Onepanel.StorageGetDetails);
  }
}(this, function(ApiClient, NulldeviceCredentials, StorageGetDetails) {
  'use strict';
  ...
  /**
   * The NulldeviceGet model module.
   * @module model/NulldeviceGet
   * @version 25.1
   */

  /**
   * Constructs a new <code>NulldeviceGet</code>.
   * The Null Device storage configuration.
   * @alias module:model/NulldeviceGet
   * @class
   * @extends module:model/StorageGetDetails
   * @implements module:model/NulldeviceCredentials
   * @param type {module:model/NulldeviceGet.TypeEnum} The type of storage.  `type = \"nulldevice\"`  POSIX compatible storage which emulates behavior of `/dev/null` on local filesystem. Allows running various performance tests, which are not impacted by actual storage latency. 
   */
   ...
   *
   * @return {module:model/NulldeviceGet} The value of 'discriminator' field or undefined.
   */
  ...
  /**
   * Constructs a <code>NulldeviceGet</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/NulldeviceGet} obj Optional instance to populate.
   * @return {module:model/NulldeviceGet} The populated <code>NulldeviceGet</code> instance.
   */
  exports.constructFromObject = function(data, obj) {
    if (data) {
      obj = obj || new exports();
      StorageGetDetails.constructFromObject(data, obj);
      NulldeviceCredentials.constructFromObject(data, obj);
   ...
   * @member {module:model/NulldeviceGet.TypeEnum} type
   */
   ...
   * @member {module:model/NulldeviceGet.StoragePathTypeEnum} storagePathType
   */
