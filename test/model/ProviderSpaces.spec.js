...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Onepanel.ProviderSpaces();
  });
  ...
  describe('ProviderSpaces', function() {
    it('should create an instance of ProviderSpaces', function() {
      // uncomment below and update the code to test ProviderSpaces
      //var instane = new Onepanel.ProviderSpaces();
      //expect(instance).to.be.a(Onepanel.ProviderSpaces);
    });
