...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.Onepanel.ManagerHosts = factory(root.Onepanel.ApiClient);
  }
  ...
  /**
   * The ManagerHosts model module.
   * @module model/ManagerHosts
   * @version 18.02.1
   */

  /**
   * Constructs a new <code>ManagerHosts</code>.
   ...
   *
   * @return {module:model/ManagerHosts} The value of 'discriminator' field or undefined.
   */
  ...
  /**
   * Constructs a <code>ManagerHosts</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/ManagerHosts} obj Optional instance to populate.
   * @return {module:model/ManagerHosts} The populated <code>ManagerHosts</code> instance.
   */
  exports.constructFromObject = function(data, obj) {
    if (data) {
      obj = obj || new exports();

      if (data.hasOwnProperty('mainHost')) {
        obj['mainHost'] = ApiClient.convertToType(data['mainHost'], 'String');
      }
