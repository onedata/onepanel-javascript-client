...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Onepanel.CephradosGet();
  });
  ...
  describe('CephradosGet', function() {
    it('should create an instance of CephradosGet', function() {
      // uncomment below and update the code to test CephradosGet
      //var instane = new Onepanel.CephradosGet();
      //expect(instance).to.be.a(Onepanel.CephradosGet);
    });
