...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/CephradosCommon', 'model/CephradosCredentials', 'model/StorageCommonPathTypeFlat', 'model/StorageCreateDetails'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./CephradosCommon'), require('./CephradosCredentials'), require('./StorageCommonPathTypeFlat'), require('./StorageCreateDetails'));
  } else {
    // Browser globals (root is window)
    if (!root.Onepanel) {
      root.Onepanel = {};
    }
    root.Onepanel.CephradosCreate = factory(root.Onepanel.ApiClient, root.Onepanel.CephradosCommon, root.Onepanel.CephradosCredentials, root.Onepanel.StorageCommonPathTypeFlat, root.Onepanel.StorageCreateDetails);
  }
}(this, function(ApiClient, CephradosCommon, CephradosCredentials, StorageCommonPathTypeFlat, StorageCreateDetails) {
  'use strict';
  ...
  var exports = function() {
    ...
    CephradosCredentials.call(_this);
