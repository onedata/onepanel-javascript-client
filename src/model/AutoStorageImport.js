...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.Onepanel.AutoStorageImport = factory(root.Onepanel.ApiClient);
  }
  ...
  /**
   * The AutoStorageImport model module.
   * @module model/AutoStorageImport
   * @version 20.02.1
   */

  /**
   * Constructs a new <code>AutoStorageImport</code>.
   ...
   * @alias module:model/AutoStorageImport
   * @class
   */
   ...
   *
   * @return {module:model/AutoStorageImport} The value of 'discriminator' field or undefined.
   */
  ...
  /**
   * Constructs a <code>AutoStorageImport</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/AutoStorageImport} obj Optional instance to populate.
   * @return {module:model/AutoStorageImport} The populated <code>AutoStorageImport</code> instance.
   */
