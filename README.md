...
*Onepanel.DNSWebCertificatesApi* | [**checkDns**](docs/DNSWebCertificatesApi.md#checkDns) | **GET** /dns_check | Check correctness of DNS entries for the cluster&#39;s domain.
*Onepanel.DNSWebCertificatesApi* | [**getDnsCheckConfiguration**](docs/DNSWebCertificatesApi.md#getDnsCheckConfiguration) | **GET** /dns_check/configuration | Return settings used when performing the DNS check
*Onepanel.DNSWebCertificatesApi* | [**getWebCert**](docs/DNSWebCertificatesApi.md#getWebCert) | **GET** /web_cert | Get information about SSL certificates configuration and status.
*Onepanel.DNSWebCertificatesApi* | [**modifyDnsCheckConfiguration**](docs/DNSWebCertificatesApi.md#modifyDnsCheckConfiguration) | **PATCH** /dns_check/configuration | Configure dns check
*Onepanel.DNSWebCertificatesApi* | [**modifyWebCert**](docs/DNSWebCertificatesApi.md#modifyWebCert) | **PATCH** /web_cert | Modify SSL certificate configuration
...
*Onepanel.FilePopularityAutocleaningApi* | [**cancelAutoCleaning**](docs/FilePopularityAutocleaningApi.md#cancelAutoCleaning) | **POST** /provider/spaces/{id}/auto-cleaning/cancel | Cancel space auto-cleaning
*Onepanel.FilePopularityAutocleaningApi* | [**configureFilePopularity**](docs/FilePopularityAutocleaningApi.md#configureFilePopularity) | **PATCH** /provider/spaces/{id}/file-popularity/configuration | Configure file-popularity mechanism in the space.
*Onepanel.FilePopularityAutocleaningApi* | [**configureSpaceAutoCleaning**](docs/FilePopularityAutocleaningApi.md#configureSpaceAutoCleaning) | **PATCH** /provider/spaces/{id}/auto-cleaning/configuration | Configure space auto-cleaning mechanism
*Onepanel.FilePopularityAutocleaningApi* | [**getFilePopularityConfiguration**](docs/FilePopularityAutocleaningApi.md#getFilePopularityConfiguration) | **GET** /provider/spaces/{id}/file-popularity/configuration | Get file-popularity configuration
*Onepanel.FilePopularityAutocleaningApi* | [**getProviderSpaceAutoCleaningReport**](docs/FilePopularityAutocleaningApi.md#getProviderSpaceAutoCleaningReport) | **GET** /provider/spaces/{id}/auto-cleaning/reports/{report_id} | Get the report from a space auto-cleaning run
*Onepanel.FilePopularityAutocleaningApi* | [**getProviderSpaceAutoCleaningReports**](docs/FilePopularityAutocleaningApi.md#getProviderSpaceAutoCleaningReports) | **GET** /provider/spaces/{id}/auto-cleaning/reports | Get Ids of of the space auto-cleaning reports
*Onepanel.FilePopularityAutocleaningApi* | [**getProviderSpaceAutoCleaningStatus**](docs/FilePopularityAutocleaningApi.md#getProviderSpaceAutoCleaningStatus) | **GET** /provider/spaces/{id}/auto-cleaning/status | Get status of space auto-cleaning mechanism
*Onepanel.FilePopularityAutocleaningApi* | [**getSpaceAutoCleaningConfiguration**](docs/FilePopularityAutocleaningApi.md#getSpaceAutoCleaningConfiguration) | **GET** /provider/spaces/{id}/auto-cleaning/configuration | Get space auto-cleaning configuration
*Onepanel.FilePopularityAutocleaningApi* | [**triggerAutoCleaning**](docs/FilePopularityAutocleaningApi.md#triggerAutoCleaning) | **POST** /provider/spaces/{id}/auto-cleaning/start | Trigger space auto-cleaning
