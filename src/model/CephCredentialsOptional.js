...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.Onepanel.CephCredentialsOptional = factory(root.Onepanel.ApiClient, root.Onepanel.LumaStorageCredentials);
  }
  ...
  /**
   * The CephCredentialsOptional model module.
   * @module model/CephCredentialsOptional
   * @version 20.02.1
   */

  /**
   * Constructs a new <code>CephCredentialsOptional</code>.
   * Credentials on the CEPH storage.
   * @alias module:model/CephCredentialsOptional
   * @class
   ...
   *
   * @return {module:model/CephCredentialsOptional} The value of 'discriminator' field or undefined.
   */
  ...
  /**
   * Constructs a <code>CephCredentialsOptional</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/CephCredentialsOptional} obj Optional instance to populate.
   * @return {module:model/CephCredentialsOptional} The populated <code>CephCredentialsOptional</code> instance.
   */
