...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Onepanel.AutoStorageImportScanConfig();
  });
  ...
  describe('AutoStorageImportScanConfig', function() {
    it('should create an instance of AutoStorageImportScanConfig', function() {
      // uncomment below and update the code to test AutoStorageImportScanConfig
      //var instane = new Onepanel.AutoStorageImportScanConfig();
      //expect(instance).to.be.a(Onepanel.AutoStorageImportScanConfig);
    });
