...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Onepanel.OnezoneRedirect();
  });
  ...
  describe('OnezoneRedirect', function() {
    it('should create an instance of OnezoneRedirect', function() {
      // uncomment below and update the code to test OnezoneRedirect
      //var instane = new Onepanel.OnezoneRedirect();
      //expect(instance).to.be.a(Onepanel.OnezoneRedirect);
    });
