...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Onepanel.ZoneConfiguration();
  });
  ...
  describe('ZoneConfiguration', function() {
    it('should create an instance of ZoneConfiguration', function() {
      // uncomment below and update the code to test ZoneConfiguration
      //var instane = new Onepanel.ZoneConfiguration();
      //expect(instance).to.be.a(Onepanel.ZoneConfiguration);
    });
