...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Onepanel.OpPanelConfigurationAdmin();
  });
  ...
  describe('OpPanelConfigurationAdmin', function() {
    it('should create an instance of OpPanelConfigurationAdmin', function() {
      // uncomment below and update the code to test OpPanelConfigurationAdmin
      //var instane = new Onepanel.OpPanelConfigurationAdmin();
      //expect(instance).to.be.a(Onepanel.OpPanelConfigurationAdmin);
    });
