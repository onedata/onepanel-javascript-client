...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Onepanel.ZoneConfigurationOnezone();
  });
  ...
  describe('ZoneConfigurationOnezone', function() {
    it('should create an instance of ZoneConfigurationOnezone', function() {
      // uncomment below and update the code to test ZoneConfigurationOnezone
