...
(function(root, factory) {
  ...
  var exports = function(apiClient) {
     ...
     * @param {module:model/String} id Possible values are:   - cookie_consent_notification - for the contents of cookie consent popup   - privacy_policy - for the contents of privacy policy document   - acceptable_use_policy - for the contents of Acceptable Use Policy (AUP) document   - signin_notification - for the message displayed on the Onezone sign in screen 
