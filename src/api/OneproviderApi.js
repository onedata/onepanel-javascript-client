...
(function(root, factory) {
  ...
  var exports = function(apiClient) {
     ...
     * @param {module:model/StorageCreateDetails} storageCreateRequest The configuration details of storage resources to be added to the provider deployment. 
