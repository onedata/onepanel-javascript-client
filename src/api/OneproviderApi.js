...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/Error', 'model/ManagerHosts', 'model/ProviderConfiguration', 'model/ProviderConfigurationDetails', 'model/ProviderDetails', 'model/ProviderModifyRequest', 'model/ProviderRegisterRequest', 'model/ProviderSpaces', 'model/ProviderStorages', 'model/ServiceDatabases', 'model/ServiceError', 'model/ServiceHosts', 'model/ServiceStatus', 'model/ServiceStatusHost', 'model/SpaceAutoCleaning', 'model/SpaceAutoCleaningReports', 'model/SpaceAutoCleaningStatus', 'model/SpaceDetails', 'model/SpaceFilesPopularity', 'model/SpaceModifyRequest', 'model/SpaceSupportRequest', 'model/SpaceSyncStats', 'model/StorageCreateRequest', 'model/StorageDetails', 'model/StorageModifyRequest'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('../model/Error'), require('../model/ManagerHosts'), require('../model/ProviderConfiguration'), require('../model/ProviderConfigurationDetails'), require('../model/ProviderDetails'), require('../model/ProviderModifyRequest'), require('../model/ProviderRegisterRequest'), require('../model/ProviderSpaces'), require('../model/ProviderStorages'), require('../model/ServiceDatabases'), require('../model/ServiceError'), require('../model/ServiceHosts'), require('../model/ServiceStatus'), require('../model/ServiceStatusHost'), require('../model/SpaceAutoCleaning'), require('../model/SpaceAutoCleaningReports'), require('../model/SpaceAutoCleaningStatus'), require('../model/SpaceDetails'), require('../model/SpaceFilesPopularity'), require('../model/SpaceModifyRequest'), require('../model/SpaceSupportRequest'), require('../model/SpaceSyncStats'), require('../model/StorageCreateRequest'), require('../model/StorageDetails'), require('../model/StorageModifyRequest'));
  } else {
    // Browser globals (root is window)
    if (!root.Onepanel) {
      root.Onepanel = {};
    }
    root.Onepanel.OneproviderApi = factory(root.Onepanel.ApiClient, root.Onepanel.Error, root.Onepanel.ManagerHosts, root.Onepanel.ProviderConfiguration, root.Onepanel.ProviderConfigurationDetails, root.Onepanel.ProviderDetails, root.Onepanel.ProviderModifyRequest, root.Onepanel.ProviderRegisterRequest, root.Onepanel.ProviderSpaces, root.Onepanel.ProviderStorages, root.Onepanel.ServiceDatabases, root.Onepanel.ServiceError, root.Onepanel.ServiceHosts, root.Onepanel.ServiceStatus, root.Onepanel.ServiceStatusHost, root.Onepanel.SpaceAutoCleaning, root.Onepanel.SpaceAutoCleaningReports, root.Onepanel.SpaceAutoCleaningStatus, root.Onepanel.SpaceDetails, root.Onepanel.SpaceFilesPopularity, root.Onepanel.SpaceModifyRequest, root.Onepanel.SpaceSupportRequest, root.Onepanel.SpaceSyncStats, root.Onepanel.StorageCreateRequest, root.Onepanel.StorageDetails, root.Onepanel.StorageModifyRequest);
  }
}(this, function(ApiClient, Error, ManagerHosts, ProviderConfiguration, ProviderConfigurationDetails, ProviderDetails, ProviderModifyRequest, ProviderRegisterRequest, ProviderSpaces, ProviderStorages, ServiceDatabases, ServiceError, ServiceHosts, ServiceStatus, ServiceStatusHost, SpaceAutoCleaning, SpaceAutoCleaningReports, SpaceAutoCleaningStatus, SpaceDetails, SpaceFilesPopularity, SpaceModifyRequest, SpaceSupportRequest, SpaceSyncStats, StorageCreateRequest, StorageDetails, StorageModifyRequest) {
  'use strict';
  ...
  var exports = function(apiClient) {
    ...
    this.configureSpaceFilesPopularity = function(id, callback) {
      ...
      // verify the required parameter 'id' is set
      if (id === undefined || id === null) {
        throw new Error("Missing the required parameter 'id' when calling configureSpaceFilesPopularity");
      }
    ...
    /**
     * Callback function to receive the result of the getProviderSpaceAutoCleaning operation.
     * @callback module:api/OneproviderApi~getProviderSpaceAutoCleaningCallback
     * @param {String} error Error message, if any.
     * @param {module:model/SpaceAutoCleaning} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {String} id The ID of a space
     * @param {module:api/OneproviderApi~getProviderSpaceAutoCleaningCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/SpaceAutoCleaning}
     */
    this.getProviderSpaceAutoCleaning = function(id, callback) {
      var postBody = null;

      // verify the required parameter 'id' is set
      if (id === undefined || id === null) {
        throw new Error("Missing the required parameter 'id' when calling getProviderSpaceAutoCleaning");
      }
      ...
      return this.apiClient.callApi(
        '/provider/spaces/{id}/auto_cleaning', 'GET',
        pathParams, queryParams, headerParams, formParams, postBody,
        authNames, contentTypes, accepts, returnType, callback
      );
    }
     ...
     */
    this.getProviderSpaceAutoCleaningReports = function(id, callback) {
      var postBody = null;
      ...
      return this.apiClient.callApi(
        '/provider/spaces/{id}/auto_cleaning/reports', 'GET',
        pathParams, queryParams, headerParams, formParams, postBody,
        authNames, contentTypes, accepts, returnType, callback
      );
    }
    ...
    this.getProviderSpaceAutoCleaningStatus = function(id, callback) {
      ...
      return this.apiClient.callApi(
        '/provider/spaces/{id}/auto_cleaning/status', 'GET',
        pathParams, queryParams, headerParams, formParams, postBody,
        authNames, contentTypes, accepts, returnType, callback
      );
    }
    ...
    /**
     * Callback function to receive the result of the getProviderSpaceFilesPopularity operation.
     * @callback module:api/OneproviderApi~getProviderSpaceFilesPopularityCallback
     * @param {String} error Error message, if any.
     * @param {module:model/SpaceFilesPopularity} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {String} id The ID of a space
     * @param {module:api/OneproviderApi~getProviderSpaceFilesPopularityCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/SpaceFilesPopularity}
     */
    this.getProviderSpaceFilesPopularity = function(id, callback) {
      var postBody = null;

      // verify the required parameter 'id' is set
      if (id === undefined || id === null) {
        throw new Error("Missing the required parameter 'id' when calling getProviderSpaceFilesPopularity");
      }
      ...
      return this.apiClient.callApi(
        '/provider/spaces/{id}/files_popularity', 'GET',
        pathParams, queryParams, headerParams, formParams, postBody,
        authNames, contentTypes, accepts, returnType, callback
      );
    }
