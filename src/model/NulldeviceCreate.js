...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/NulldeviceCredentials', 'model/StorageCreateDetails'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./NulldeviceCredentials'), require('./StorageCreateDetails'));
  } else {
    // Browser globals (root is window)
    if (!root.Onepanel) {
      root.Onepanel = {};
    }
    root.Onepanel.NulldeviceCreate = factory(root.Onepanel.ApiClient, root.Onepanel.NulldeviceCredentials, root.Onepanel.StorageCreateDetails);
  }
}(this, function(ApiClient, NulldeviceCredentials, StorageCreateDetails) {
  'use strict';
  ...
  /**
   * The NulldeviceCreate model module.
   * @module model/NulldeviceCreate
   * @version 21.02.8
   */

  /**
   * Constructs a new <code>NulldeviceCreate</code>.
   * The Null Device storage configuration.
   * @alias module:model/NulldeviceCreate
   * @class
   * @extends module:model/StorageCreateDetails
   * @implements module:model/NulldeviceCredentials
   * @param type {module:model/NulldeviceCreate.TypeEnum} The type of storage.  `type = \"nulldevice\"`  POSIX compatible storage which emulates behavior of `/dev/null` on local filesystem. Allows running various performance tests, which are not impacted by actual storage latency. 
   */
   ...
   *
   * @return {module:model/NulldeviceCreate} The value of 'discriminator' field or undefined.
   */
  ...
  /**
   * Constructs a <code>NulldeviceCreate</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/NulldeviceCreate} obj Optional instance to populate.
   * @return {module:model/NulldeviceCreate} The populated <code>NulldeviceCreate</code> instance.
   */
