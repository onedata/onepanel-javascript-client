...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Onepanel.ProviderConfigurationDetails();
  });
  ...
  describe('ProviderConfigurationDetails', function() {
    it('should create an instance of ProviderConfigurationDetails', function() {
      // uncomment below and update the code to test ProviderConfigurationDetails
      //var instane = new Onepanel.ProviderConfigurationDetails();
      //expect(instance).to.be.a(Onepanel.ProviderConfigurationDetails);
    });
