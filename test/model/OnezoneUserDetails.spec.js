...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Onepanel.OnezoneUserDetails();
  });
  ...
  describe('OnezoneUserDetails', function() {
    it('should create an instance of OnezoneUserDetails', function() {
      // uncomment below and update the code to test OnezoneUserDetails
      //var instane = new Onepanel.OnezoneUserDetails();
      //expect(instance).to.be.a(Onepanel.OnezoneUserDetails);
    });
