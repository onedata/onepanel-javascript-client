...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Onepanel.CephPoolUsage();
  });
  ...
  describe('CephPoolUsage', function() {
    it('should create an instance of CephPoolUsage', function() {
      // uncomment below and update the code to test CephPoolUsage
      //var instane = new Onepanel.CephPoolUsage();
      //expect(instance).to.be.a(Onepanel.CephPoolUsage);
    });
