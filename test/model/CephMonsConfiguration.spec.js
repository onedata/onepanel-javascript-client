...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Onepanel.CephMonsConfiguration();
  });
  ...
  describe('CephMonsConfiguration', function() {
    it('should create an instance of CephMonsConfiguration', function() {
      // uncomment below and update the code to test CephMonsConfiguration
      //var instane = new Onepanel.CephMonsConfiguration();
      //expect(instance).to.be.a(Onepanel.CephMonsConfiguration);
    });
