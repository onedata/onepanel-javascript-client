...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Onepanel.ClusterMembership();
  });
  ...
  describe('ClusterMembership', function() {
    it('should create an instance of ClusterMembership', function() {
      // uncomment below and update the code to test ClusterMembership
      //var instane = new Onepanel.ClusterMembership();
      //expect(instance).to.be.a(Onepanel.ClusterMembership);
    });
