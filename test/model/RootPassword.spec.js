...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Onepanel.RootPassword();
  });
  ...
  describe('RootPassword', function() {
    it('should create an instance of RootPassword', function() {
      // uncomment below and update the code to test RootPassword
      //var instane = new Onepanel.RootPassword();
      //expect(instance).to.be.a(Onepanel.RootPassword);
    });
