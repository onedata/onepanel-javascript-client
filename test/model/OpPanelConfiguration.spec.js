...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Onepanel.OpPanelConfiguration();
  });
  ...
  describe('OpPanelConfiguration', function() {
    it('should create an instance of OpPanelConfiguration', function() {
      // uncomment below and update the code to test OpPanelConfiguration
      //var instane = new Onepanel.OpPanelConfiguration();
      //expect(instance).to.be.a(Onepanel.OpPanelConfiguration);
    });
