...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Onepanel.DnsCheckResults();
  });
  ...
  describe('DnsCheckResults', function() {
    it('should create an instance of DnsCheckResults', function() {
      // uncomment below and update the code to test DnsCheckResults
      //var instane = new Onepanel.DnsCheckResults();
      //expect(instance).to.be.a(Onepanel.DnsCheckResults);
    });
