...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.Onepanel.LumaOnedataUserScheme = factory(root.Onepanel.ApiClient, root.Onepanel.LumaOnedataUser);
  }
  ...
  /**
   * The LumaOnedataUserScheme model module.
   * @module model/LumaOnedataUserScheme
   ...
   * @param mappingScheme {module:model/LumaOnedataUserScheme.MappingSchemeEnum} Name of scheme used to represent user identity.
   * @param onedataUserId {String} The id of user in Onedata system.
   */
  var exports = function(mappingScheme, onedataUserId) {
    var _this = this;
    LumaOnedataUser.call(_this);
    _this['mappingScheme'] = mappingScheme;
    _this['onedataUserId'] = onedataUserId;
  };
   ...
   *
   * @return {module:model/LumaOnedataUserScheme} The value of 'discriminator' field or undefined.
   */
  ...
  /**
   * Constructs a <code>LumaOnedataUserScheme</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/LumaOnedataUserScheme} obj Optional instance to populate.
   * @return {module:model/LumaOnedataUserScheme} The populated <code>LumaOnedataUserScheme</code> instance.
   */
   ...
   * @member {module:model/LumaOnedataUserScheme.MappingSchemeEnum} mappingScheme
   */
