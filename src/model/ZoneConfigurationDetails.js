...
(function(root, factory) {
  ...
  /**
   * The ZoneConfigurationDetails model module.
   * @module model/ZoneConfigurationDetails
   * @version 18.02.1
   */

  /**
   * Constructs a new <code>ZoneConfigurationDetails</code>.
   ...
   *
   * @return {module:model/ZoneConfigurationDetails} The value of 'discriminator' field or undefined.
   */
  ...
  /**
   * Constructs a <code>ZoneConfigurationDetails</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/ZoneConfigurationDetails} obj Optional instance to populate.
   * @return {module:model/ZoneConfigurationDetails} The populated <code>ZoneConfigurationDetails</code> instance.
   */
  ...
  /**
   * @member {module:model/ZoneConfigurationDetailsOnezone} onezone
   */
