...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Onepanel.ProgressModify();
  });
  ...
  describe('ProgressModify', function() {
    it('should create an instance of ProgressModify', function() {
      // uncomment below and update the code to test ProgressModify
      //var instane = new Onepanel.ProgressModify();
      //expect(instance).to.be.a(Onepanel.ProgressModify);
    });
