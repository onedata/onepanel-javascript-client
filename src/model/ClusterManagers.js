...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.Onepanel.ClusterManagers = factory(root.Onepanel.ApiClient);
  }
  ...
  /**
   * The ClusterManagers model module.
   * @module model/ClusterManagers
   * @version 19.02.0-beta1
   */

  /**
   * Constructs a new <code>ClusterManagers</code>.
   * The cluster manager service configuration.
   * @alias module:model/ClusterManagers
   * @class
   * @param mainNode {String} The alias of the main cluster manager node.
   * @param nodes {Array.<String>} The list of aliases of cluster manager nodes.
   */
  var exports = function(mainNode, nodes) {
    var _this = this;

    _this['mainNode'] = mainNode;
    _this['nodes'] = nodes;
  };
   ...
   *
   * @return {module:model/ClusterManagers} The value of 'discriminator' field or undefined.
   */
  ...
  /**
   * Constructs a <code>ClusterManagers</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/ClusterManagers} obj Optional instance to populate.
   * @return {module:model/ClusterManagers} The populated <code>ClusterManagers</code> instance.
   */
  exports.constructFromObject = function(data, obj) {
    if (data) {
      obj = obj || new exports();

      if (data.hasOwnProperty('mainNode')) {
        obj['mainNode'] = ApiClient.convertToType(data['mainNode'], 'String');
      }
   ...
   * @member {String} mainNode
   */
  exports.prototype['mainNode'] = undefined;
  /**
