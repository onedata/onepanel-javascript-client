...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Onepanel.ProviderConfigurationOnezone();
  });
  ...
  describe('ProviderConfigurationOnezone', function() {
    it('should create an instance of ProviderConfigurationOnezone', function() {
      // uncomment below and update the code to test ProviderConfigurationOnezone
      //var instane = new Onepanel.ProviderConfigurationOnezone();
      //expect(instance).to.be.a(Onepanel.ProviderConfigurationOnezone);
    });
