...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Onepanel.ServiceHosts();
  });
  ...
  describe('ServiceHosts', function() {
    it('should create an instance of ServiceHosts', function() {
      // uncomment below and update the code to test ServiceHosts
      //var instane = new Onepanel.ServiceHosts();
      //expect(instance).to.be.a(Onepanel.ServiceHosts);
    });
