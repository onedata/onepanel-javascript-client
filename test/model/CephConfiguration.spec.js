...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Onepanel.CephConfiguration();
  });
  ...
  describe('CephConfiguration', function() {
    it('should create an instance of CephConfiguration', function() {
      // uncomment below and update the code to test CephConfiguration
