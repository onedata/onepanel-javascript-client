...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Onepanel.EmergencyPassphraseStatus();
  });
  ...
  describe('EmergencyPassphraseStatus', function() {
    it('should create an instance of EmergencyPassphraseStatus', function() {
      // uncomment below and update the code to test EmergencyPassphraseStatus
      //var instane = new Onepanel.EmergencyPassphraseStatus();
      //expect(instance).to.be.a(Onepanel.EmergencyPassphraseStatus);
    });
