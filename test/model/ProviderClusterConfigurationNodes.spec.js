...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Onepanel.ProviderClusterConfigurationNodes();
  });
  ...
  describe('ProviderClusterConfigurationNodes', function() {
    it('should create an instance of ProviderClusterConfigurationNodes', function() {
      // uncomment below and update the code to test ProviderClusterConfigurationNodes
      //var instane = new Onepanel.ProviderClusterConfigurationNodes();
      //expect(instance).to.be.a(Onepanel.ProviderClusterConfigurationNodes);
    });
