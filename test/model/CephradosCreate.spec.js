...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Onepanel.CephradosCreate();
  });
  ...
  describe('CephradosCreate', function() {
    it('should create an instance of CephradosCreate', function() {
      // uncomment below and update the code to test CephradosCreate
      //var instane = new Onepanel.CephradosCreate();
      //expect(instance).to.be.a(Onepanel.CephradosCreate);
    });
