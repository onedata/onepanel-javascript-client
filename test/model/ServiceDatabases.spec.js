...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Onepanel.ServiceDatabases();
  });
  ...
  describe('ServiceDatabases', function() {
    it('should create an instance of ServiceDatabases', function() {
      // uncomment below and update the code to test ServiceDatabases
      //var instane = new Onepanel.ServiceDatabases();
      //expect(instance).to.be.a(Onepanel.ServiceDatabases);
    });
