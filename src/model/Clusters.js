...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.Onepanel.Clusters = factory(root.Onepanel.ApiClient);
  }
   ...
   * @class
   * @param clusters {Array.<String>} The list of cluster ids.
   */
  var exports = function(clusters) {
    var _this = this;
   ...
   *
   * @return {module:model/Clusters} The value of 'discriminator' field or undefined.
   */
