...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.Onepanel.RootPasswordStatus = factory(root.Onepanel.ApiClient);
  }
  ...
  /**
   * The RootPasswordStatus model module.
   * @module model/RootPasswordStatus
   * @version 18.02.1
   */

  /**
   * Constructs a new <code>RootPasswordStatus</code>.
   * Root password status.
   * @alias module:model/RootPasswordStatus
   * @class
   */
   ...
   *
   * @return {module:model/RootPasswordStatus} The value of 'discriminator' field or undefined.
   */
  ...
  /**
   * Constructs a <code>RootPasswordStatus</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/RootPasswordStatus} obj Optional instance to populate.
   * @return {module:model/RootPasswordStatus} The populated <code>RootPasswordStatus</code> instance.
   */
  ...
  /**
   * True if the root password is set.
