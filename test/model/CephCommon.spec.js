...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Onepanel.CephCommon();
  });
  ...
  describe('CephCommon', function() {
    it('should create an instance of CephCommon', function() {
      // uncomment below and update the code to test CephCommon
      //var instane = new Onepanel.CephCommon();
      //expect(instance).to.be.a(Onepanel.CephCommon);
    });
