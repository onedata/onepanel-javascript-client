...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Onepanel.SpaceFilePopularity();
  });
  ...
  describe('SpaceFilePopularity', function() {
    it('should create an instance of SpaceFilePopularity', function() {
      // uncomment below and update the code to test SpaceFilePopularity
      //var instane = new Onepanel.SpaceFilePopularity();
      //expect(instance).to.be.a(Onepanel.SpaceFilePopularity);
    });
