...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Onepanel.NulldeviceCreate();
  });
  ...
  describe('NulldeviceCreate', function() {
    it('should create an instance of NulldeviceCreate', function() {
      // uncomment below and update the code to test NulldeviceCreate
      //var instane = new Onepanel.NulldeviceCreate();
      //expect(instance).to.be.a(Onepanel.NulldeviceCreate);
    });
