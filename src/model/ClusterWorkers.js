...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.Onepanel.ClusterWorkers = factory(root.Onepanel.ApiClient);
  }
   ...
   * @class
   * @param nodes {Array.<String>} The list of aliases of cluster worker nodes.
   */
   ...
   *
   * @return {module:model/ClusterWorkers} The value of 'discriminator' field or undefined.
   */
