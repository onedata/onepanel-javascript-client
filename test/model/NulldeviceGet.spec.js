...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Onepanel.NulldeviceGet();
  });
  ...
  describe('NulldeviceGet', function() {
    it('should create an instance of NulldeviceGet', function() {
      // uncomment below and update the code to test NulldeviceGet
      //var instane = new Onepanel.NulldeviceGet();
      //expect(instance).to.be.a(Onepanel.NulldeviceGet);
    });
