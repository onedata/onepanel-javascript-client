...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Onepanel.RemoteOnezone();
  });
  ...
  describe('RemoteOnezone', function() {
    it('should create an instance of RemoteOnezone', function() {
      // uncomment below and update the code to test RemoteOnezone
      //var instane = new Onepanel.RemoteOnezone();
      //expect(instance).to.be.a(Onepanel.RemoteOnezone);
    });
