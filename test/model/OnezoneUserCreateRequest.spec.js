...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Onepanel.OnezoneUserCreateRequest();
  });
  ...
  describe('OnezoneUserCreateRequest', function() {
    it('should create an instance of OnezoneUserCreateRequest', function() {
      // uncomment below and update the code to test OnezoneUserCreateRequest
      //var instane = new Onepanel.OnezoneUserCreateRequest();
      //expect(instance).to.be.a(Onepanel.OnezoneUserCreateRequest);
    });
