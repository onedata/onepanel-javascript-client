...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/StorageCreateDetails', 'model/XRootDCredentials'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./StorageCreateDetails'), require('./XRootDCredentials'));
  } else {
    // Browser globals (root is window)
    if (!root.Onepanel) {
      root.Onepanel = {};
    }
    root.Onepanel.XRootDCreate = factory(root.Onepanel.ApiClient, root.Onepanel.StorageCreateDetails, root.Onepanel.XRootDCredentials);
  }
}(this, function(ApiClient, StorageCreateDetails, XRootDCredentials) {
  'use strict';
   ...
   * @param type {module:model/XRootDCreate.TypeEnum} The type of storage.  `type = \"xrootd\"`  Storage backend compatible with [XRootD](http://www.xrootd.org/) protocol. 
   ...
   * @member {module:model/XRootDCreate.TypeEnum} type
   */
