...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.Onepanel.S3Common = factory(root.Onepanel.ApiClient);
  }
  ...
  /**
   * The S3Common model module.
   * @module model/S3Common
   * @version 20.02.1
   */

  /**
   * Constructs a new <code>S3Common</code>.
   * The Simple Storage Service configuration.
   * @alias module:model/S3Common
   * @class
   */
   ...
   *
   * @return {module:model/S3Common} The value of 'discriminator' field or undefined.
   */
  ...
  /**
   * Constructs a <code>S3Common</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/S3Common} obj Optional instance to populate.
   * @return {module:model/S3Common} The populated <code>S3Common</code> instance.
   */
