...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Onepanel.XRootDModify();
  });
  ...
  describe('XRootDModify', function() {
    it('should create an instance of XRootDModify', function() {
      // uncomment below and update the code to test XRootDModify
