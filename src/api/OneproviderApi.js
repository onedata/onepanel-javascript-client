...
(function(root, factory) {
  ...
  var exports = function(apiClient) {
    ...
    /**
     * Callback function to receive the result of the checkProviderDns operation.
     * @callback module:api/OneproviderApi~checkProviderDnsCallback
     * @param {String} error Error message, if any.
     ...
     */
    this.checkProviderDns = function(callback) {
      var postBody = null;
    ...
    /**
     * Callback function to receive the result of the modifyDnsCheck operation.
     * @callback module:api/OneproviderApi~modifyDnsCheckCallback
     * @param {String} error Error message, if any.
     * @param data This operation does not return a value.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {module:model/DnsCheckConfiguration} dnsCheckConfiguration The configuration chagnes.
     * @param {module:api/OneproviderApi~modifyDnsCheckCallback} callback The callback function, accepting three arguments: error, data, response
     */
    this.modifyDnsCheck = function(dnsCheckConfiguration, callback) {
      ...
      if (dnsCheckConfiguration === undefined || dnsCheckConfiguration === null) {
        throw new Error("Missing the required parameter 'dnsCheckConfiguration' when calling modifyDnsCheck");
      }
