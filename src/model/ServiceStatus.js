...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/ServiceStatusHost'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./ServiceStatusHost'));
  } else {
    // Browser globals (root is window)
    if (!root.Onepanel) {
      root.Onepanel = {};
    }
    root.Onepanel.ServiceStatus = factory(root.Onepanel.ApiClient, root.Onepanel.ServiceStatusHost);
  }
}(this, function(ApiClient, ServiceStatusHost) {
  'use strict';
   ...
   *
   * @return {module:model/ServiceStatus} The value of 'discriminator' field or undefined.
   */
