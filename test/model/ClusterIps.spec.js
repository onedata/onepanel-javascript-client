...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Onepanel.ClusterIps();
  });
  ...
  describe('ClusterIps', function() {
    it('should create an instance of ClusterIps', function() {
      // uncomment below and update the code to test ClusterIps
      //var instane = new Onepanel.ClusterIps();
      //expect(instance).to.be.a(Onepanel.ClusterIps);
    });
