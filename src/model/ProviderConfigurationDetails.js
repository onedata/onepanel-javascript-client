...
(function(root, factory) {
  ...
  /**
   * The ProviderConfigurationDetails model module.
   * @module model/ProviderConfigurationDetails
   * @version 18.02.1
   */

  /**
   * Constructs a new <code>ProviderConfigurationDetails</code>.
   ...
   *
   * @return {module:model/ProviderConfigurationDetails} The value of 'discriminator' field or undefined.
   */
  ...
  /**
   * Constructs a <code>ProviderConfigurationDetails</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/ProviderConfigurationDetails} obj Optional instance to populate.
   * @return {module:model/ProviderConfigurationDetails} The populated <code>ProviderConfigurationDetails</code> instance.
   */
