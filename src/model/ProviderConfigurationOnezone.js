...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.Onepanel.ProviderConfigurationOnezone = factory(root.Onepanel.ApiClient);
  }
  ...
  /**
   * The ProviderConfigurationOnezone model module.
   * @module model/ProviderConfigurationOnezone
   * @version 17.06.0-beta5
   */

  /**
   * Constructs a new <code>ProviderConfigurationOnezone</code>.
   * The zone custom configuration.
   * @alias module:model/ProviderConfigurationOnezone
   * @class
   * @param domainName {String} The domain name of a zone where provider will be registered.
   */
   ...
   *
   * @return {module:model/ProviderConfigurationOnezone} The value of 'discriminator' field or undefined.
   */
  ...
  /**
   * Constructs a <code>ProviderConfigurationOnezone</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/ProviderConfigurationOnezone} obj Optional instance to populate.
   * @return {module:model/ProviderConfigurationOnezone} The populated <code>ProviderConfigurationOnezone</code> instance.
   */
