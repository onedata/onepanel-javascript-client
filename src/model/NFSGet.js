...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/NFSCredentials', 'model/StorageGetDetails'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./NFSCredentials'), require('./StorageGetDetails'));
  } else {
    // Browser globals (root is window)
    if (!root.Onepanel) {
      root.Onepanel = {};
    }
    root.Onepanel.NFSGet = factory(root.Onepanel.ApiClient, root.Onepanel.NFSCredentials, root.Onepanel.StorageGetDetails);
  }
}(this, function(ApiClient, NFSCredentials, StorageGetDetails) {
  'use strict';
  ...
  /**
   * The NFSGet model module.
   * @module model/NFSGet
   * @version 21.02.8
   */

  /**
   * Constructs a new <code>NFSGet</code>.
   * The NFS storage configuration.
   * @alias module:model/NFSGet
   * @class
   * @extends module:model/StorageGetDetails
   * @implements module:model/NFSCredentials
   * @param type {module:model/NFSGet.TypeEnum} The type of storage.  `type = \"nfs\"`  NFS storage. 
   ...
   *
   * @return {module:model/NFSGet} The value of 'discriminator' field or undefined.
   */
  ...
  /**
   * Constructs a <code>NFSGet</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/NFSGet} obj Optional instance to populate.
   * @return {module:model/NFSGet} The populated <code>NFSGet</code> instance.
   */
   ...
   * @member {module:model/NFSGet.TypeEnum} type
   */
   ...
   * @member {module:model/NFSGet.StoragePathTypeEnum} storagePathType
   */
