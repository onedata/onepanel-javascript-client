...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Onepanel.ClusterDatabases();
  });
  ...
  describe('ClusterDatabases', function() {
    it('should create an instance of ClusterDatabases', function() {
      // uncomment below and update the code to test ClusterDatabases
      //var instane = new Onepanel.ClusterDatabases();
      //expect(instance).to.be.a(Onepanel.ClusterDatabases);
    });
    ...
    it('should have the property serverQuota (base name: "serverQuota")', function() {
      // uncomment below and update the code to test the property serverQuota
      //var instane = new Onepanel.ClusterDatabases();
      //expect(instance).to.be();
    });

    it('should have the property bucketQuota (base name: "bucketQuota")', function() {
      // uncomment below and update the code to test the property bucketQuota
      //var instane = new Onepanel.ClusterDatabases();
      //expect(instance).to.be();
    });
