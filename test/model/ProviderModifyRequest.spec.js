...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Onepanel.ProviderModifyRequest();
  });
  ...
  describe('ProviderModifyRequest', function() {
    it('should create an instance of ProviderModifyRequest', function() {
      // uncomment below and update the code to test ProviderModifyRequest
      //var instane = new Onepanel.ProviderModifyRequest();
      //expect(instance).to.be.a(Onepanel.ProviderModifyRequest);
    });
